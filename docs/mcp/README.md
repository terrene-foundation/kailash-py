...
### For Migration
- [MCP Migration Guide](/sdk-users/migration-guides/specialized/mcp-comprehensive-migration.md) - Comprehensive MCP migration
- [All Migration Guides](/sdk-users/migration-guides/) - Version, architectural, and specialized migrations
...
- [MCP Patterns Guide](/sdk-users/patterns/12-mcp-patterns.md)
- [MCP Development Guide](/sdk-users/developer/22-mcp-development-guide.md)
- [MCP Cheatsheet](/sdk-users/cheatsheet/025-mcp-integration.md)
