...
latex_documents = [
    (master_doc, 'KailashPythonSDK.tex', 'Kailash Python SDK Documentation',
     'Terrene Foundation', 'manual'),
]

# Manual page output
man_pages = [
    (master_doc, 'kailashpythonsdk', 'Kailash Python SDK Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'KailashPythonSDK', 'Kailash Python SDK Documentation',
     author, 'KailashPythonSDK', 'Python SDK for Kailash container-node architecture.',
     'Miscellaneous'),
]
