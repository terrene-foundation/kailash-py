...
class LogNotificationChannel(NotificationChannel):
    ...
    def send_notification(self, alert: Alert, context: Dict[str, Any]) -> bool:
        ...
        message = f"ALERT [{alert.severity.value.upper()}] {alert.title}: {alert.description}"
...
class AlertManager:
        ...
        with self._lock:
            for rule in self.rules.values():
                ...
                try:
                    ...
                    for collector_name, collector in self.metrics_registry.get_all_collectors().items():
    ...
    def _evaluate_rule(self, rule: AlertRule, metric_series: MetricSeries, collector_name: str):
        ...
        if condition_met:
            ...
            if alert_id not in self.alerts:
                alert = Alert(
                    ...
                    labels={**rule.labels, "collector": collector_name, "metric": rule.metric_name},
