...
class OperationalConstraints:
    ...
    # tightening check had already passed (GH #2225). The sibling
    # ``pact.config.OperationalConstraintConfig`` already spells these two
    # fields as tuples for the same reason.
    ...
    def to_dict(self) -> dict[str, Any]:
        # Emit LISTS: this feeds envelope_hash / serialize_for_signing, and a
        # tuple must not change the serialized bytes.
        return {
...
class DataAccessConstraints:
    ...
    def to_dict(self) -> dict[str, Any]:
        # Emit LISTS -- see OperationalConstraints.to_dict (signing bytes).
        return {
