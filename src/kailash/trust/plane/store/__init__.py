...
(see ``src/kailash/trust/plane/CLAUDE.md``):
...
class TrustPlaneStore(Protocol):
    ...
    documented in ``src/kailash/trust/plane/CLAUDE.md``.
    """
...
from kailash.trust.plane.store.sqlite import SqliteTrustPlaneStore  # noqa: E402, F401
