...
class ConfigManager:
    ...
    def get(self, key: str, default: Any = None) -> Any:
        ...
        for config in [self._runtime_config, self._env_config, 
                      self._file_config, self._defaults]:
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        for config in [self._defaults, self._file_config, 
                      self._env_config, self._runtime_config]:
