...
class MetricsCollector:
    ...
    def track_tool_call(self, tool_name: str, latency: float, success: bool = True,
    ...
    def get_tool_stats(self) -> Dict[str, Dict[str, Any]]:
        ...
        with self._lock:
            ...
            for tool_name in set(list(self._tool_calls.keys()) + list(self._tool_errors.keys())):
    ...
    def get_server_stats(self) -> Dict[str, Any]:
        ...
        with self._lock:
            ...
            stats = {
                ...
                "overall_error_rate": self._total_errors / self._total_calls if self._total_calls > 0 else 0,
            ...
            if self.collect_performance:
                ...
                recent_calls = [call for call in self._recent_calls 
                ...
                if recent_calls:
                    ...
                    stats.update({
                        ...
                        "recent_avg_latency_5min": sum(recent_latencies) / len(recent_latencies),
                        "recent_p95_latency_5min": self._percentile(recent_latencies, 95)
                    })
    ...
    def get_error_summary(self) -> Dict[str, Any]:
        ...
        with self._lock:
            ...
            recent_errors = [error for error in self._recent_errors
    ...
    def _export_prometheus(self, metrics: Dict[str, Any]) -> str:
        ...
        for tool_name, tool_stats in metrics["tools"].items():
            ...
            if "avg_latency" in tool_stats:
                lines.append(f"mcp_tool_latency_avg{labels} {tool_stats['avg_latency']}")
                lines.append(f"mcp_tool_latency_p95{labels} {tool_stats['p95_latency']}")
                lines.append(f"mcp_tool_latency_p99{labels} {tool_stats['p99_latency']}")
