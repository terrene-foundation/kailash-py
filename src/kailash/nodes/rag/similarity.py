...
class DenseRetrievalNode(Node):
    ...
    def __init__(self, name: str = "dense_retrieval",
...
class SparseRetrievalNode(Node):
    ...
    def __init__(self, name: str = "sparse_retrieval",
                 method: str = "bm25",
    ...
    def run(self, **kwargs) -> Dict[str, Any]:
        ...
        try:
            ...
            avg_doc_length = sum(len(doc.get("content", "").split()) for doc in documents) / doc_count if doc_count > 0 else 0
            ...
            for i, doc in enumerate(documents):
                ...
                for term in query_terms:
                    ...
                    if tf > 0:
                        ...
                        df = sum(1 for d in documents if term in d.get("content", "").lower())
    ...
    def _create_workflow(self) -> WorkflowNode:
        ...
        if self.use_query_expansion:
            expander_id = builder.add_node("LLMAgentNode",
        ...
        sparse_retriever_id = builder.add_node("PythonCodeNode",
...
"""
        ...
        # Connect workflow
        if self.use_query_expansion:
            builder.add_connection(expander_id, "response", sparse_retriever_id, "expanded_terms")
...
class ColBERTRetrievalNode(Node):
    ...
    def __init__(self, name: str = "colbert_retrieval",
                 token_model: str = "bert-base-uncased"):
    ...
    def _create_workflow(self) -> WorkflowNode:
        ...
        # Add token embedder
        token_embedder_id = builder.add_node("PythonCodeNode",
...
"""
        ...
        late_interaction_id = builder.add_node("PythonCodeNode",
...
"""
        ...
        # Connect workflow
        builder.add_connection(token_embedder_id, "token_data", late_interaction_id, "token_data")
...
class MultiVectorRetrievalNode(Node):
        ...
        try:
            ...
            if query and documents:
                ...
                for i, doc in enumerate(documents):
                    ...
                    full_score = len(query_words.intersection(set(full_content.split())))
                    summary_score = len(query_words.intersection(set(summary.split())))
                    keyword_score = len(query_words.intersection(set(keywords)))
                    
                    # Weighted combination
                    combined_score = (0.5 * full_score + 0.3 * summary_score + 0.2 * keyword_score) / len(query_words) if query_words else 0.0
    ...
    def _create_workflow(self) -> WorkflowNode:
        ...
        doc_processor_id = builder.add_node("PythonCodeNode",
...
"""
        ...
        # Add multi-embedder
        multi_embedder_id = builder.add_node("PythonCodeNode",
...
"""
        ...
        # Add batch embedder
        batch_embedder_id = builder.add_node("EmbeddingGeneratorNode",
            node_id="batch_embedder",
            config={"model": "text-embedding-3-small"}
        )
        
        # Add fusion scorer
        fusion_scorer_id = builder.add_node("PythonCodeNode",
...
"""
        ...
        # Connect workflow
        builder.add_connection(doc_processor_id, "multi_docs", multi_embedder_id, "multi_docs")
        builder.add_connection(multi_embedder_id, "embedding_requests", batch_embedder_id, "texts")
        builder.add_connection(batch_embedder_id, "embeddings", fusion_scorer_id, "embeddings")
        builder.add_connection(multi_embedder_id, "embedding_requests", fusion_scorer_id, "embedding_requests")
...
class CrossEncoderRerankNode(Node):
    ...
    def __init__(self, name: str = "cross_encoder_rerank",
    ...
    def _create_workflow(self) -> WorkflowNode:
        ...
        reranker_id = builder.add_node("LLMAgentNode",
        ...
        rerank_orchestrator_id = builder.add_node("PythonCodeNode",
...
"""
        ...
        # Connect workflow
        builder.add_connection(rerank_orchestrator_id, "rerank_requests", reranker_id, "messages")
        builder.add_connection(reranker_id, "response", result_aggregator_id, "rerank_scores")
        builder.add_connection(rerank_orchestrator_id, "rerank_requests", result_aggregator_id, "rerank_requests")
...
class HybridFusionNode(Node):
    ...
    def __init__(self, name: str = "hybrid_fusion",
    ...
    def _create_workflow(self) -> WorkflowNode:
        ...
        fusion_processor_id = builder.add_node("PythonCodeNode",
...
class PropositionBasedRetrievalNode(Node):
        ...
        try:
            ...
            if query and documents:
                ...
                for i, doc in enumerate(documents):
                    ...
                    propositions = [s.strip() + "." for s in sentences if len(s.strip()) > 20]
    ...
    def _create_workflow(self) -> WorkflowNode:
        ...
        proposition_extractor_id = builder.add_node("LLMAgentNode",
        ...
        proposition_indexer_id = builder.add_node("PythonCodeNode",
...
"""
        ...
        proposition_retriever_id = builder.add_node("PythonCodeNode",
...
"""
        ...
        # Connect workflow
        builder.add_connection(proposition_extractor_id, "response", proposition_indexer_id, "proposition_results")
        builder.add_connection(proposition_indexer_id, "indexed_propositions", proposition_retriever_id, "indexed_propositions")
