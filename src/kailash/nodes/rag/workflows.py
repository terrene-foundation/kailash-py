...
from .strategies import create_semantic_rag_workflow, create_statistical_rag_workflow, create_hybrid_rag_workflow, create_hierarchical_rag_workflow, RAGConfig
...
class SimpleRAGWorkflowNode(WorkflowNode):
    ...
    def __init__(self, name: str = "simple_rag_workflow", config: Optional[RAGConfig] = None):
...
class AdvancedRAGWorkflowNode(WorkflowNode):
    ...
    def __init__(self, name: str = "advanced_rag_workflow", config: Optional[RAGConfig] = None):
        self.rag_config = config or RAGConfig()
    ...
    def _create_advanced_workflow(self):
        ...
        quality_analyzer_id = builder.add_node("PythonCodeNode",
...
"""
        ...
        router_id = builder.add_node("SwitchNode",
...
class AdaptiveRAGWorkflowNode(WorkflowNode):
    ...
    def __init__(self, name: str = "adaptive_rag_workflow", 
                 llm_model: str = "gpt-4", config: Optional[RAGConfig] = None):
        self.rag_config = config or RAGConfig()
    ...
    def _create_adaptive_workflow(self):
        ...
        llm_analyzer_id = builder.add_node("LLMAgentNode",
...
Recommend the optimal RAG strategy:"""
        ...
        preprocessor_id = builder.add_node("PythonCodeNode",
...
"""
        ...
        executor_id = builder.add_node("SwitchNode",
        ...
        semantic_pipeline_id = builder.add_node("WorkflowNode",
            node_id="semantic_pipeline",
            config={"workflow": semantic_workflow.workflow})
        
        statistical_pipeline_id = builder.add_node("WorkflowNode",
            node_id="statistical_pipeline",
            config={"workflow": statistical_workflow.workflow})
        
        hybrid_pipeline_id = builder.add_node("WorkflowNode", 
            node_id="hybrid_pipeline",
            config={"workflow": hybrid_workflow.workflow})
        
        hierarchical_pipeline_id = builder.add_node("WorkflowNode",
...
"""
        ...
        builder.add_connection(preprocessor_id, "result", executor_id, "preprocessed_data")
        
        # Connect executor to strategy pipelines
        builder.add_connection(executor_id, semantic_pipeline_id, route="semantic")
        builder.add_connection(executor_id, statistical_pipeline_id, route="statistical")
        builder.add_connection(executor_id, hybrid_pipeline_id, route="hybrid") 
        builder.add_connection(executor_id, hierarchical_pipeline_id, route="hierarchical")
        
        # Connect all pipelines to aggregator
        builder.add_connection(semantic_pipeline_id, "output", aggregator_id, "rag_results")
        builder.add_connection(statistical_pipeline_id, "output", aggregator_id, "rag_results")
        builder.add_connection(hybrid_pipeline_id, "output", aggregator_id, "rag_results")
        builder.add_connection(hierarchical_pipeline_id, "output", aggregator_id, "rag_results")
        builder.add_connection(llm_analyzer_id, "result", aggregator_id, "llm_decision")
        builder.add_connection(preprocessor_id, "result", aggregator_id, "preprocessed_data")
...
class RAGPipelineWorkflowNode(WorkflowNode):
    ...
    def _create_configurable_workflow(self):
        ...
        config_processor_id = builder.add_node("PythonCodeNode",
...
"""
        ...
        # Strategy dispatcher
        dispatcher_id = builder.add_node("SwitchNode",
...
"""
        ...
        for strategy_name, strategy_id in strategy_ids.items():
            builder.add_connection(dispatcher_id, strategy_id, route=f"{strategy_name}_strategy")
            builder.add_connection(strategy_id, "output", formatter_id, "strategy_results")
        
        builder.add_connection(config_processor_id, "result", formatter_id, "processed_config")
