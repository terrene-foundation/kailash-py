...
from .strategies import (
    ...
    create_hybrid_rag_workflow, create_hierarchical_rag_workflow, RAGConfig
)
from .workflows import (
    SimpleRAGWorkflowNode, AdvancedRAGWorkflowNode, 
    AdaptiveRAGWorkflowNode, RAGPipelineWorkflowNode
)
from .router import RAGStrategyRouterNode, RAGQualityAnalyzerNode, RAGPerformanceMonitorNode
...
class RAGWorkflowRegistry:
    ...
    def _register_components(self):
        ...
        self._strategies = {
            "semantic": {
                ...
                "performance": {"speed": "fast", "accuracy": "high", "complexity": "low"}
            },
            "statistical": {
            ...
            "hybrid": {
                ...
                "performance": {"speed": "medium", "accuracy": "very high", "complexity": "medium"}
            },
            "hierarchical": {
                ...
                "use_cases": ["long documents", "structured content", "complex queries"],
                "strengths": ["maintains context", "handles complex documents"],
                "performance": {"speed": "slow", "accuracy": "very high", "complexity": "high"}
            }
        }
        ...
        self._workflows = {
            ...
            "advanced": {
                ...
                "features": ["strategy selection", "quality validation", "performance monitoring"]
            },
            "adaptive": {
                "class": AdaptiveRAGWorkflowNode,
                "description": "AI-driven strategy selection",
                "complexity": "advanced", 
                "features": ["LLM-powered routing", "automatic optimization", "context awareness"]
            },
            "configurable": {
                "class": RAGPipelineWorkflowNode,
                "description": "Flexible pipeline for custom configurations",
                "complexity": "intermediate",
                "features": ["runtime configuration", "strategy switching", "custom parameters"]
            }
        }
    ...
    def recommend_strategy(self, 
                         ...
                         performance_priority: str = "accuracy") -> Dict[str, Any]:
        """
    ...
    def recommend_workflow(self, 
                          ...
                          needs_monitoring: bool = False) -> Dict[str, Any]:
        """
        ...
        return {
            ...
            "suggested_utilities": self._get_suggested_utilities(workflow, needs_monitoring)
        }
    
    def _get_suggested_utilities(self, workflow: str, needs_monitoring: bool) -> List[str]:
    ...
    def create_strategy(self, strategy_name: str, config: Optional[RAGConfig] = None, **kwargs):
    ...
    def create_workflow(self, workflow_name: str, config: Optional[RAGConfig] = None, **kwargs):
        """Create a workflow instance"""
        if workflow_name not in self._workflows:
            raise ValueError(f"Unknown workflow: {workflow_name}. Available: {list(self._workflows.keys())}")
    ...
    def create_utility(self, utility_name: str, **kwargs):
        ...
        if utility_name not in self._utilities:
            raise ValueError(f"Unknown utility: {utility_name}. Available: {list(self._utilities.keys())}")
