...
class GraphRAGNode(WorkflowNode):
    ...
    def __init__(self, name: str = "graph_rag",
                 entity_types: List[str] = None,
                 relationship_types: List[str] = None,
                 max_hops: int = 2,
                 community_algorithm: str = "louvain",
                 use_global_summary: bool = True):
        self.entity_types = entity_types or ["person", "organization", "concept", "technology"]
        self.relationship_types = relationship_types or ["relates_to", "influences", "uses", "created_by"]
    ...
    def _create_workflow(self) -> WorkflowNode:
        ...
        # Entity extraction
        entity_extractor_id = builder.add_node("LLMAgentNode",
        ...
        # Graph builder
        graph_builder_id = builder.add_node("PythonCodeNode",
...
"""
        ...
        query_processor_id = builder.add_node("LLMAgentNode",
        ...
        graph_retriever_id = builder.add_node("PythonCodeNode",
...
"""
        ...
        if self.use_global_summary:
            summary_generator_id = builder.add_node("LLMAgentNode",
        ...
        # Result synthesizer
        result_synthesizer_id = builder.add_node("PythonCodeNode",
...
"""
        ...
        # Connect workflow
        builder.add_connection(entity_extractor_id, "response", graph_builder_id, "extraction_results")
        builder.add_connection(query_processor_id, "response", graph_retriever_id, "query_analysis")
        builder.add_connection(graph_builder_id, "graph_data", graph_retriever_id, "graph_data")
        builder.add_connection(graph_retriever_id, "graph_retrieval", result_synthesizer_id, "graph_retrieval")
        builder.add_connection(graph_builder_id, "graph_data", result_synthesizer_id, "graph_data")
        
        if self.use_global_summary:
            builder.add_connection(graph_builder_id, "graph_data", summary_generator_id, "graph_data")
            builder.add_connection(summary_generator_id, "response", result_synthesizer_id, "global_summaries")
...
class GraphBuilderNode(Node):
    ...
    def __init__(self, name: str = "graph_builder",
    ...
    def run(self, **kwargs) -> Dict[str, Any]:
        ...
        if query_type == "path":
            ...
            results["aggregations"] = {
                ...
                "clustering_coefficient": nx.average_clustering(G.to_undirected()) if len(G) > 0 else 0
            }
