...
def create_semantic_rag_workflow(config: RAGConfig) -> WorkflowNode:
    ...
    # Add chunking node
    chunker_id = builder.add_node("SemanticChunkerNode", 
    ...
    embedder_id = builder.add_node("EmbeddingGeneratorNode",
        node_id="embedder", 
        config={
    ...
    vectordb_id = builder.add_node("VectorDatabaseNode",
        node_id="vector_db",
        config={
    ...
    # Add retrieval node
    retriever_id = builder.add_node("HybridRetrieverNode",
        node_id="retriever",
        config={
    ...
    builder.add_connection(vectordb_id, "stored_documents", retriever_id, "document_store")
...
def create_statistical_rag_workflow(config: RAGConfig) -> WorkflowNode:
    ...
    chunker_id = builder.add_node("StatisticalChunkerNode",
    ...
    keyword_extractor_id = builder.add_node("PythonCodeNode",
...
def create_hybrid_rag_workflow(config: RAGConfig, fusion_method: str = "rrf") -> WorkflowNode:
    """
    ...
    fusion_id = builder.add_node("PythonCodeNode",
...
def create_hierarchical_rag_workflow(config: RAGConfig) -> WorkflowNode:
    ...
    chunker_id = builder.add_node("HierarchicalChunkerNode",
    ...
    level_processor_id = builder.add_node("PythonCodeNode",
...
"""
    ...
    doc_vectordb_id = builder.add_node("VectorDatabaseNode",
    ...
    section_vectordb_id = builder.add_node("VectorDatabaseNode",
    ...
    para_vectordb_id = builder.add_node("VectorDatabaseNode",
    ...
    builder.add_connection(chunker_id, "chunks", embedder_id, "texts")
    builder.add_connection(level_processor_id, "result", doc_vectordb_id, "level_chunks")
    builder.add_connection(level_processor_id, "result", section_vectordb_id, "level_chunks") 
    builder.add_connection(level_processor_id, "result", para_vectordb_id, "level_chunks")
    ...
    builder.add_connection(doc_vectordb_id, "stored_documents", retriever_id, "document_store")
    builder.add_connection(section_vectordb_id, "stored_documents", retriever_id, "section_store")
    builder.add_connection(para_vectordb_id, "stored_documents", retriever_id, "paragraph_store")
...
class StatisticalRAGNode(Node):
    ...
    def __init__(self, name: str = "statistical_rag", config: Optional[RAGConfig] = None):
        self.config = config or RAGConfig()
        self.workflow_node = None
        super().__init__(name)
...
class HybridRAGNode(Node):
    ...
    def __init__(self, name: str = "hybrid_rag", config: Optional[RAGConfig] = None, fusion_method: str = "rrf"):
        self.config = config or RAGConfig()
...
class HierarchicalRAGNode(Node):
    ...
    def __init__(self, name: str = "hierarchical_rag", config: Optional[RAGConfig] = None):
        self.config = config or RAGConfig()
        self.workflow_node = None
        super().__init__(name)
