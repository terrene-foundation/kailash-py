...
class RateLimitedAPINode(Node):
    ...
    def __init__(self, wrapped_node: Node, rate_limit_config: RateLimitConfig, **kwargs):
...
class AsyncRateLimitedAPINode(AsyncNode):
    ...
    def __init__(self, wrapped_node: AsyncNode, rate_limit_config: RateLimitConfig, **kwargs):
        ...
        self.rate_limiter = create_rate_limiter(rate_limit_config)
        self.config = rate_limit_config
        self.sync_node = RateLimitedAPINode(
            wrapped_node, rate_limit_config, **kwargs
        )
