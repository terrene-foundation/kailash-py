...
class DockerNode(AsyncNode):
    ...
    async def _create_container(self, **kwargs) -> Dict[str, Any]:
        ...
        try:
            ...
            container_spec = ContainerSpec(
                ...
                restart_policy=RestartPolicyType(kwargs.get("restart_policy", "unless-stopped")),
    ...
    async def _stop_container(self, **kwargs) -> Dict[str, Any]:
        ...
        try:
            result = await self.docker_integration.stop_container(container_id, stop_timeout)
    ...
    async def _list_containers(self, **kwargs) -> Dict[str, Any]:
        ...
        try:
            containers = await self.docker_integration.list_containers(all_containers, filters)
    ...
    async def _update_service(self, **kwargs) -> Dict[str, Any]:
        ...
        try:
            ...
            result = await self.docker_integration.update_service(service_id, service_spec)
    ...
    async def _collect_metrics(self, **kwargs) -> Dict[str, Any]:
        ...
        try:
            metrics = await self.docker_integration.collect_container_metrics(container_id)
    ...
    async def _stop_monitoring(self, **kwargs) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                ...
                "result": {
                    "message": "Docker monitoring stopped"
                }
            }
