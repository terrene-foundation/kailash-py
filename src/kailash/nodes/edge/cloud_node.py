...
class CloudNode(AsyncNode):
    ...
    async def _initialize_cloud(self, **kwargs) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                ...
                "result": {
                    "message": "Cloud integration initialized successfully"
                }
            }
    ...
    async def _terminate_instance(self, **kwargs) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                "status": result.get("status", "unknown"),
                "instance_terminated": result.get("status") in ["terminating", "deleting"],
                "result": result
            }
    ...
    async def _get_provider_info(self, **kwargs) -> Dict[str, Any]:
        ...
        try:
            provider_info = await self.cloud_integration.get_provider_info(CloudProvider(provider))
    ...
    async def _stop_monitoring(self, **kwargs) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                ...
                "result": {
                    "message": "Cloud monitoring stopped"
                }
            }
