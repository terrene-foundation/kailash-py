...
class ValidationMetricsCollector:
    ...
    def start_validation(self, node_id: str, node_type: str, validation_mode: str) -> None:
        ...
        if self.enable_detailed_logging:
            self.logger.debug(f"Validation started for {node_id} ({node_type}) in {validation_mode} mode")
    ...
    def end_validation(
        ...
        event_type = (ValidationEventType.VALIDATION_COMPLETED if success 
        ...
        metric = ValidationMetric(
            ...
            connection_source=connection_info.get("source") if connection_info else None,
            connection_target=connection_info.get("target") if connection_info else None
        )
        self.metrics.append(metric)
        ...
        if self.enable_detailed_logging:
            ...
            self.logger.debug(f"Validation {status} for {node_id} ({node_type}){duration_str}")
    ...
    def get_performance_summary(self) -> Dict[str, Any]:
        ...
        total_validations = sum(
            ...
            if m.event_type in [ValidationEventType.VALIDATION_COMPLETED, 
        ...
        cache_hit_rate = (self._cache_stats["hits"] / total_cache_ops * 100 
        ...
        return {
            ...
            "mode_bypasses": sum(1 for m in self.metrics 
    ...
    def get_security_report(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "most_recent_violations": [
                ...
                for v in sorted(self.security_violations, 
