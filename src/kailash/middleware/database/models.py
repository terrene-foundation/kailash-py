...
class WorkflowModel(Base):
    ...
    permissions = relationship("WorkflowPermissionModel", back_populates="workflow", cascade="all, delete-orphan")
...
class WorkflowPermissionModel(Base):
    ...
    # What permission?
    permission = Column(String(50), nullable=False)  # view, execute, modify, delete, share, admin
    effect = Column(String(20), nullable=False, default="allow")  # allow, deny, conditional
...
class NodePermissionModel(Base):
    ...
    # What permission?
    permission = Column(String(50), nullable=False)  # execute, read_output, write_input, skip, mask_output
...
class AccessLogModel(Base):
    ...
    real_time_logged = Column(Boolean, default=False)  # Whether logged to real-time stream
...
class UserGroupModel(Base):
    ...
    # Relationships
    members = relationship("UserGroupMemberModel", back_populates="group", cascade="all, delete-orphan")
...
class MiddlewareEventModel(Base):
    ...
    event_source = Column(String(50), nullable=False)  # agent_ui, api_gateway, realtime, etc.
