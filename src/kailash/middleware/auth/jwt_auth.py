...
class JWTConfig:
    ...
    algorithm: str = "HS256"  # Use HMAC instead of RSA to avoid external crypto dependencies
...
class JWTAuthManager:
    ...
    def get_stats(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "key_id": self._key_id,
            "key_age_days": (
                datetime.now(timezone.utc) - self._key_generated_at
            ).days if self._key_generated_at else 0,
