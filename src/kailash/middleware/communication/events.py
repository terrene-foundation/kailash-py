...
class EventStream:
    ...
    def __init__(self, enable_batching: bool = True, batch_size: int = 10):
        ...
        self.subscribers: Dict[str, Dict] = {}  # subscriber_id -> {filter, callback, active}
    ...
    def _init_sdk_nodes(self):
        ...
        self.batch_processor = BatchProcessorNode(
    ...
    def get_stats(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "delivery_rate": self.events_delivered / self.events_emitted if self.events_emitted > 0 else 0,
