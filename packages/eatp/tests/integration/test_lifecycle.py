...
from eatp.interop.jwt import export_chain_as_jwt, export_capability_as_jwt
...
class TestDecoratorIntegration:
    ...
    async def test_audited_decorator_records_action(self, ops, execution_ctx):
        ...
        from eatp.enforce.decorators import audited
        ...
        from eatp.execution_context import execution_context
    ...
    async def test_shadow_decorator_never_blocks(self, ops):
        ...
        from eatp.enforce.decorators import shadow
        from eatp.enforce.shadow import ShadowEnforcer
