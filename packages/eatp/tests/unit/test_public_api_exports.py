...
class TestReasoningExports:
    """ConfidentialityLevel and ReasoningTrace must be importable from eatp."""

    def test_confidentiality_level_importable_from_eatp(self):
        from eatp import ConfidentialityLevel
    ...
    def test_reasoning_trace_importable_from_eatp(self):
        from eatp import ReasoningTrace
    ...
    def test_reasoning_trace_identity(self):
        ...
        from eatp import ConfidentialityLevel as CL_top, ReasoningTrace as RT_top
...
class TestConstraintTypeExport:
    """ConstraintType must be importable from eatp (not just eatp.chain)."""

    def test_constraint_type_importable_from_eatp(self):
        from eatp import ConstraintType
    ...
    def test_constraint_type_identity(self):
        ...
        from eatp import ConstraintType as CT_top
        from eatp.chain import ConstraintType as CT_mod
...
class TestAllExports:
    ...
    def test_confidentiality_level_in_all(self):
        ...
        assert "ConfidentialityLevel" in eatp.__all__

    def test_reasoning_trace_in_all(self):
        import eatp

        assert "ReasoningTrace" in eatp.__all__

    def test_constraint_type_in_all(self):
        import eatp

        assert "ConstraintType" in eatp.__all__
...
class TestExistingExportsIntact:
    ...
    def test_existing_export_still_importable(self, name):
        ...
        assert hasattr(eatp, name), f"{name} missing from eatp after changes"
        assert name in eatp.__all__, f"{name} missing from eatp.__all__"
