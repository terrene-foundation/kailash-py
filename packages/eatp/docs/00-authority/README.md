...
3. **5 Postures**: Pseudo-Agent, Supervised, Shared Planning, Continuous Insight, Delegated (SDK enum: `TrustPosture.{FULL_AUTONOMY, ASSISTED, SUPERVISED, HUMAN_DECIDES, BLOCKED}`)
