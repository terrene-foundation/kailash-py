...
workflow.add_connection("fetch", "response", "parse", "input")
...
pipeline.add_connection("fetch_data", "response", "parse_json", "input")
pipeline.add_connection("parse_json", "output", "transform", "data")
