...
Run as: python -m kailash_mcp.contrib.ai_registry
"""
...
try:
    ...
    from kailash_mcp.server import MCPServerBase as Server
...
def run_server():
    """Entry point for python -m kailash_mcp.contrib.ai_registry"""
    asyncio.run(main())
