"""DataFlow Testing Mocks.

This module contains mock implementations for testing purposes.
Moved from dataflow.core.engine_production in v0.7.0.

Classes:
    MockConnectionPool: Mock connection pool for testing
    MockConnection: Mock database connection for testing
    MockCursor: Mock database cursor for testing
    DataFlowProductionEngine: Mock production engine for testing
"""
...
class DataFlowProductionEngine:
    """Mock production-ready DataFlow engine for testing purposes.

    Warning:
        This is a mock implementation for testing only. Do not use in production.
        Use the real DataFlow class from dataflow.core.engine instead.
    """
    ...
    def __init__(
        ...
        **kwargs,
        ...
        # Warn if being used outside of tests
        import inspect
        ...
        if frame and frame.f_back:
            ...
            if "tests" not in caller_file:
                warnings.warn(
                    "DataFlowProductionEngine is a test mock and should not be used "
                    "in production code. Use DataFlow from dataflow.core.engine instead.",
                    DeprecationWarning,
                    stacklevel=2,
                )
