...
class TestSaaSDataModels:
    ...
    def test_database_url(self, tmp_path):
        """Use file-based SQLite for unit tests.

        :memory: databases use separate connections per operation, so tables
        created by create_tables() are invisible to workflow execution.
        File-based SQLite shares state across connections.
        """
