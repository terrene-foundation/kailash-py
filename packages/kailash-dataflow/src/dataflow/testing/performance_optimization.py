...
class ConnectionPoolManager:
    ...
    async def create_optimized_pool(
        ...
        logger.debug(
            "performance_optimization.created_optimized_pool_ms",
            extra={"pool_id": pool_id, "creation_time": creation_time},
        )
        return pool
    ...
    async def _preheat_pool(self, pool_id: str, pool: asyncpg.Pool):
        ...
        try:
            ...
            logger.debug(
                "performance_optimization.preheated_pool_ms",
                extra={"pool_id": pool_id, "preheat_time": preheat_time},
            )

        except Exception as e:
            logger.error(
                "performance_optimization.failed_to_preheat_pool",
                extra={"pool_id": pool_id, "error": str(e)},
            )
    ...
    async def get_optimized_connection(self, pool_id: str) -> asyncpg.Connection:
        ...
        if acquisition_time > 10.0:  # 10ms threshold
            logger.warning(
                "performance_optimization.slow_connection_acquisition_ms",
                extra={"acquisition_time": acquisition_time},
            )
    ...
    async def cleanup_pool(self, pool_id: str):
        ...
        with self._lock:
            if pool_id in self.pools:
                ...
                logger.debug(
                    "performance_optimization.cleaned_up_pool",
    ...
    async def cleanup_all_pools(self):
        ...
        for callback in self.cleanup_callbacks:
            try:
                ...
                logger.warning(
                    "performance_optimization.cleanup_callback_failed",
                    extra={"error": str(e)},
                )
...
class SchemaCache:
    ...
    def cache_schema(self, schema_id: str, tables: Dict[str, str], version: int = 1):
        ...
        logger.debug(
            "performance_optimization.cached_schema_with_tables",
            extra={"schema_id": schema_id, "count": len(tables)},
        )
    ...
    def invalidate_schema(self, schema_id: str):
        ...
        with self._cache_lock:
            if schema_id in self.cached_schemas:
                ...
                logger.debug(
                    "performance_optimization.invalidated_schema_cache_for",
    ...
    def _trigger_regression_alert(self, metrics: PerformanceMetrics):
        ...
        for callback in self.alert_callbacks:
            try:
                ...
                logger.error(
                    "performance_optimization.alert_callback_failed",
                    extra={"error": str(e)},
                )
...
class MemoryOptimizer:
    ...
    def cleanup_tracked_objects(self):
        ...
        logger.debug(
            "performance_optimization.cleaned_up_objects",
...
async def optimized_test_context(
    ...
    try:
        ...
        logger.error(
            "performance_optimization.error_in_optimized_test_context",
...
async def cleanup_optimization_infrastructure():
    ...
    try:
        ...
        logger.error(
            "performance_optimization.error_during_optimization_cleanup",
            extra={"error": str(e)},
        )
