...
from trustplane._locking import safe_read_json as _safe_read_json
...
class ConformanceSuite:
    ...
    async def _test_mirror_execution_records(self, project: Any) -> bool:
        ...
        from trustplane.models import ExecutionRecord
    ...
    async def _test_mirror_escalation_records(self, project: Any) -> bool:
        ...
        from trustplane.models import EscalationRecord, HumanCompetency
    ...
    async def _test_mirror_intervention_records(self, project: Any) -> bool:
        ...
        from trustplane.models import HumanCompetency, InterventionRecord
