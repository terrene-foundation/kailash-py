...
- `AZURE_AI_FOUNDRY_ENDPOINT` + `AZURE_AI_FOUNDRY_API_KEY` + `AZURE_AI_FOUNDRY_DEPLOYMENT` - Azure AI Foundry (four-axis `azure_ai_foundry` provider — the unified, model-agnostic model-inference endpoint; `AZURE_AI_FOUNDRY_API_VERSION` optional)
