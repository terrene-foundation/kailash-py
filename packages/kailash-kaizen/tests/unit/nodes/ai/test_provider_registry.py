...
class TestAzureProviderRegistry:
    ...
    def test_azure_uses_unified_provider(self, monkeypatch):
        """'azure' should resolve to UnifiedAzureProvider."""
    ...
    def test_azure_openai_uses_unified_provider(self, monkeypatch):
        """'azure_openai' alias should resolve to UnifiedAzureProvider."""
        monkeypatch.setenv("AZURE_ENDPOINT", "https://test.openai.azure.com")
        monkeypatch.setenv("AZURE_API_KEY", "test-key")
