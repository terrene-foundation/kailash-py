...
class TestMetadataConsistency:
    """Test suite for metadata consistency (pyproject.toml vs __init__.py)."""
    ...
    def test_version_matches_init(self, pyproject_data, package_root):
    ...
    def test_name_is_kailash_kaizen(self, pyproject_data):
        """Test that package name is kailash-kaizen."""
        assert pyproject_data["project"]["name"] == "kailash-kaizen"
