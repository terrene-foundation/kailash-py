...
```bash
# Install Kaizen framework (latest v2.46.1)
pip install kailash-kaizen

# Or specific version
pip install kailash-kaizen==2.46.1
```
...
**Ready to get started?** Begin with our **[Quickstart Tutorial](docs/getting-started/quickstart.md)** or explore **[Working Examples](../../../packages/kailash-kaizen/examples/)**.
