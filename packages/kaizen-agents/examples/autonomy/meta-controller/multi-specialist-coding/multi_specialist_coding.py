...
class TestGenerationAgent(BaseAgent):
    ...
    def generate_tests(self, task: str) -> Dict:
        ...
        print(f"✅ Tests generated: {result['framework']} framework")
        return result
...
class DocumentationAgent(BaseAgent):
    ...
    def generate_documentation(self, task: str) -> Dict:
        ...
        print(f"✅ Documentation created: {len(result['sections'])} sections")
        return result
...
class RoutingMetricsHook:
    ...
    async def pre_routing(self, context: HookContext) -> HookResult:
        ...
        print("📊 Routing: Analyzing task requirements...")
    ...
    async def post_routing(self, context: HookContext) -> HookResult:
        ...
        print(f"✅ Routing: Selected {selected_agent} (score: {score:.2f})")
        return HookResult(success=True)
...
class MultiSpecialistRouter:
    ...
    async def route_task(self, task: str) -> Dict:
        ...
        """
        print(f"\n🔍 Routing Analysis for task: {task[:80]}...\n")
        ...
        print(f"\n✅ SELECTED: {best_agent_type} (highest match score)\n")
        print("=" * 60 + "\n")
...
async def main():
    ...
    try:
        ...
        for agent, score in result["capabilities_analyzed"].items():
            indicator = "←" if agent == result["selected_specialist"] else ""
        ...
        print("📊 Routing Strategy: Semantic (A2A protocol)")
        print(f"📈 Metrics: Logged to {metrics_hook.metrics_log_path}\n")
