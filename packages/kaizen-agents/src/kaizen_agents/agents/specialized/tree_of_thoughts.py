...
Zero-config usage:
    from kaizen_agents.agents import ToTAgent
...
class ToTAgent(BaseAgent):
    ...
    def _generate_path(self, task: str, path_id: int) -> dict[str, Any]:
        ...
        try:
            ...
            logger.error(f"Error generating path {path_id}: {scrub_local_error(e)}")
            return {
                "path_id": path_id,
                "reasoning": "",
    ...
    def _generate_paths(self, task: str) -> list[dict[str, Any]]:
        ...
        if self.tot_config.parallel_execution:
            ...
            try:
                ...
                logger.error(
                    f"Error in parallel path generation: {scrub_local_error(e)}"
                )
    ...
    def run(
        ...
        try:
            ...
            logger.error(f"Error generating paths: {scrub_local_error(e)}")
            return {
        ...
        try:
            ...
            logger.error(f"Error evaluating paths: {scrub_local_error(e)}")
            return {
        ...
        try:
            ...
            logger.error(f"Error selecting best path: {scrub_local_error(e)}")
            return {
        ...
        try:
            ...
            logger.error(f"Error executing best path: {scrub_local_error(e)}")
            return {
...
def explore_paths(task: str, **kwargs) -> dict[str, Any]:
    ...
    Example:
        >>> from kaizen_agents.agents.specialized.tree_of_thoughts import explore_paths
