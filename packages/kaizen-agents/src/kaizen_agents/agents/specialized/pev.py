...
Zero-config usage:
    from kaizen_agents.agents import PEVAgent
    ...
    def run(
        ...
        for iteration in range(self.pev_config.max_iterations):
            ...
            try:
                ...
                execution_result = {"status": "failed", "error": scrub_remote_error(e)}
...
def verify_and_refine(task: str, **kwargs) -> dict[str, Any]:
    ...
    Example:
        >>> from kaizen_agents.agents.specialized.pev import verify_and_refine
