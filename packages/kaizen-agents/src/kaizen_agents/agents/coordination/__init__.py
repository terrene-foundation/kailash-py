...
OLD: from kaizen_agents.agents.coordination import create_supervisor_worker_pattern
NEW: from kaizen_agents.patterns.patterns import create_supervisor_worker_pattern
...
from kaizen_agents.patterns.patterns.handoff import (
    HandoffAgent,
    HandoffPattern,
