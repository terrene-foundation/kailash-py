...
Usage:
    from kaizen_agents.agents import SimpleQAAgent, ReActAgent, RAGResearchAgent
    ...
    from kaizen_agents.agents import BatchProcessingAgent
    batch_agent = BatchProcessingAgent(max_concurrent=20)

    # Human-in-the-loop for compliance
    from kaizen_agents.agents import HumanApprovalAgent
