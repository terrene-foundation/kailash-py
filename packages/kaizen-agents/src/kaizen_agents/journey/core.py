...
class Pathway(metaclass=PathwayMeta):
    ...
    def _build_pipeline(self, agents: List["BaseAgent"]) -> "Pipeline":
        ...
        try:
            ...
            raise ImportError(
                "Install kaizen-agents for journey pipeline execution: "
...
class PathwayManager(EnhancedPathwayManager):
    ...
    This class is re-exported from kaizen_agents.journey.manager for backward
...
class DetailedJourneyResponse:
    ...
    For simpler use cases, use JourneyResponse from kaizen_agents.journey.manager
...
class Journey(metaclass=JourneyMeta):
    ...
    async def process_message(self, message: str) -> DetailedJourneyResponse:
        ...
        from kaizen_agents.journey.manager import JourneyResponse as ManagerResponse
