...
sub-content. Considered hosts: - `.codex/skills/18-security-patterns/` — rejected because the skill
is reference-style guidance, not authoring discipline. - `.codex/skills/skill-authoring/` — rejected because the clause
