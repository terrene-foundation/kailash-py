---
id: "TIME-PRESSURE-DISCIPLINE"
paths: ["**/workspaces/**", "**/.claude/commands/**", "**/.claude/agents/**", "**/.session-notes", "**/journal/**"]
---
