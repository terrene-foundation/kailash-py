    ...
    async def async_run(self, **kwargs) -> Dict[str, Any]:
        ...
        if chosen_doctor and earliest_slot:
            ...
            updated_state_wrapper = state_wrapper.update_in(
                ["w1_context", "no_hmi_slot_flag"], 
                True
            )
        
        return {
            "state_wrapper": updated_state_wrapper,
...
class W1ComposeMessageNodeV2(AsyncNode):
    ...
    async def async_run(self, **kwargs) -> Dict[str, Any]:
        ...
        if no_hmi_slot or not doctor_profile or not earliest_slot:
            ...
            return {
                "state_wrapper": state_wrapper.update_in(["next_message_to_patient"], error_msg),
        ...
        # Use update_in method for clean state update
        return {
            "state_wrapper": state_wrapper.update_in(["next_message_to_patient"], reply_payload),
