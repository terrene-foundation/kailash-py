...
class HmiWorkflowImmutable:
    ...
    def _create_workflow1(self) -> Workflow:
        ...
        workflow.add_node("compose_message", W1ComposeMessageNodeImmutable(llm=self.llm))
        ...
        workflow.connect(
            ...
            "route_by_availability",
            {
                "state_wrapper": "input_data",
                "no_hmi_slot": "condition_field"
            }
        )
        ...
        logger.info("Workflow 1 (immutable) created with 6 nodes including switch node for conditional routing")
        return workflow
    ...
    async def execute_workflow1(self, state: AgentState) -> AgentState:
        ...
        """
        logger.info("Executing Workflow 1 with AsyncLocalRuntime and immutable state management")
        ...
        try:
            ...
            logger.info(f"Workflow 1 (immutable) executed successfully")
            return final_state
