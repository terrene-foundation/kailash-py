...
from examples.project_hmi.adapted.shared import (
    DoctorInfo, SlotInfo, PatientDetails, BookingContext, NRIC_Type
)
...
class HmiMcpWrapper:
    ...
    def manage_in_person_appointment(
        ...
        if schedule_type is None or schedule_type == "RESCH":
            ...
            if passport and "malaysia" in system_id.lower() and nationality.lower() != "malaysian": payload_data["passport"] = passport
            if passport_exp and "malaysia" in system_id.lower() and nationality.lower() != "malaysian": payload_data["passportexp"] = passport_exp
