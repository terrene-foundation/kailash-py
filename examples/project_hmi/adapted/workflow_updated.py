...
class HmiWorkflowV2:
    ...
    def _create_workflow1(self) -> Workflow:
        ...
        logger.info("Workflow 1 V2 created with 6 nodes including switch node for conditional routing")
        return workflow
    ...
    async def execute_workflow1(self, state: AgentState) -> AgentState:
        ...
        """
        logger.info("Executing Workflow 1 V2 with AsyncLocalRuntime and improved state management")
        ...
        try:
            ...
            results, run_id = await runtime.execute(
                self.workflow1, 
                parameters={"state_wrapper": state_wrapper}
            )
