...
def example_3_graphql_api_integration():
    ...
    for country in countries:
        print(f"    - {country['name']} ({country['code']}): Capital: {country['capital']}, Currency: {country['currency']}")
...
def example_5_rate_limiting():
    ...
    for i in range(6):  # Try to make 6 requests (more than limit)
        ...
        http_node = HTTPRequestNode(name="HTTP Client", url="https://jsonplaceholder.typicode.com/posts/1", method="GET")
