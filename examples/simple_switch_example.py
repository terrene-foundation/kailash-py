...
def create_simple_switch_workflow() -> Workflow:
    ...
    workflow.add_node(
        "results_writer",
        JSONWriter(file_path="examples/data/outputs/simple_switch_results.json"),
    )
...
def run_example():
    ...
    logger.info(
        "Results available at: examples/data/outputs/simple_switch_results.json"
    )
    ...
    try:
        output_files = [
            "examples/data/outputs/simple_switch_results.json",
