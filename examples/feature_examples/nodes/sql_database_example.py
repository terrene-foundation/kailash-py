...
def example_1_basic_sql_operations():
    ...
    insert_result = sql_node.execute(
...
def example_2_security_features():
    ...
    verify_result = sql_node.execute(
...
def example_4_error_handling():
    ...
    try:
        ...
        sql_node.execute(query="SELECT 1")
    except Exception as e:
        print(f"   ✅ Correctly caught error: {str(e)[:100]}...")
    ...
    try:
        sql_node = SQLDatabaseNode(**db_config)
        sql_node.execute()  # Missing query parameter
    except NodeExecutionError as e:
    ...
    try:
        sql_node = SQLDatabaseNode(**db_config)
        sql_node.execute(query="SELECT * FROM nonexistent_table")
    except NodeExecutionError as e:
