...
def calculate_risk_metrics(portfolio_data: dict) -> dict:
    ...
    total_value = sum(inv.get('value', 0) for inv in portfolio_data.get('investments', []))
...
def create_portfolio_analysis_workflow():
    ...
    workflow = (builder
                .add_nodes([data_fetch, risk_calc, similarity, ai_analysis, result_store])
                .connect("fetch_portfolio", "calculate_risk", {"data": "portfolio_data"})
                .connect("calculate_risk", "find_similar_portfolios", 
                ...
                .connect("find_similar_portfolios", "store_results", 
...
async def demo_with_mocked_data():
    ...
    test_portfolio = {
        ...
        "investments": [
            {"investment_id": "INV001", "name": "Tech Stock A", "value": 2000000, "type": "equity"},
            {"investment_id": "INV002", "name": "Bond Fund B", "value": 1500000, "type": "fixed_income"},
            {"investment_id": "INV003", "name": "REIT C", "value": 1500000, "type": "real_estate"}
        ]
    }
    
    # Mock similar portfolios
    similar_portfolios = [
        {"id": "PORT456", "distance": 0.05, "metadata": {"name": "Growth Portfolio Beta"}},
