...
def quick_admin_demo():
    ...
    create_role = RoleManagementNode(
        ...
        role_data={
            ...
            "attributes": {"level": "admin", "scope": "global"},
        },
        tenant_id="demo_company",
    )
    ...
    security_event = SecurityEventNode(
        ...
        event_data={
            ...
            "indicators": {"admin_level": "full", "creation_method": "api"},
    ...
    print(
        f"✅ Security event logged: {event['event_id']} (Risk: {event['risk_score']})"
    )
    ...
    print("✅ Audit event logged for compliance")
    ...
    complete_workflow = Workflow(
        workflow_id="complete_admin_flow_demo", name="complete_admin_flow"
    )
    ...
    print(
        f"✅ Access verified: {'ALLOWED' if result['verify_access']['check']['allowed'] else 'DENIED'}"
    )
    print("✅ Activity logged for audit trail")
    ...
    return {"demo_completed": True, "nodes_demonstrated": 5, "workflows_created": 6}
