...
def create_abac_rules():
    ...
    rules.append(PermissionRule(
        ...
        permission=NodePermission.EXECUTE,
        effect=PermissionEffect.ALLOW,
        conditions=create_complex_condition("not", [
            create_attribute_condition(
    ...
    rules.append(PermissionRule(
        ...
        permission=NodePermission.READ_OUTPUT,
        effect=PermissionEffect.ALLOW,
        conditions=create_complex_condition("or", [
            create_attribute_condition(
                "user.attributes.department",
                "equals",
                "hr"
...
def create_masking_rules():
    ...
    rules.append(AttributeMaskingRule(
        field_path="ssn",
        mask_type="redact",
    ...
    for user in users:
        ...
        if decision.allowed:
            ...
            if "sensitive_data" in results:
                ...
                # Apply masking
                masked_data = acm.apply_data_masking(
                    user, "sensitive_data", raw_data
                )
