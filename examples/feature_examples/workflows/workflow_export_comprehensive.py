#!/usr/bin/env python3
"""
Comprehensive Workflow Export Example

This example demonstrates how to export workflows for Kailash integration
using the actual SDK implementation, covering:

1. Basic workflow export (YAML/JSON)
2. Export with custom configuration
3. Kubernetes manifest export
4. Custom node to container mapping
5. Template-based export
6. Partial workflow export
7. Export validation
8. Execute then export workflow

Shows best practices for workflow serialization and deployment.
"""
...
def create_sample_workflow():
    ...
    output_schema = {"result": NodeParameter(name="result", type=dict, required=True)}
    ...
    workflow.connect("transformer", "classifier", {"result": "data"})
    workflow.connect("classifier", "writer", {"result": "data"})
...
def main():
    ...
    print("=== Kailash Comprehensive Workflow Export Examples ===\n")
