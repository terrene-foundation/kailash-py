...
from kailash.runtime.testing import CredentialMockData, SecurityTestHelper
...
def demonstrate_credential_testing_basics():
    ...
    test_cases = [
        ...
        (
            ...
            "jwt",
            "success",
            {"subject": "user123", "name": "Demo User"},
        ),
...
def demonstrate_validation_rules():
    ...
    for key_length in [16, 32, 64]:
        ...
        if result["valid"]:
            ...
            print(
                f"✅ Key length {key_length}: Generated key has {actual_length} chars"
            )
...
def demonstrate_error_scenarios():
    ...
    result = tester.execute(credential_type="api_key", scenario="rate_limit")
...
def demonstrate_workflow_integration():
    ...
    workflow = Workflow(
        workflow_id="credential_test_workflow", name="Credential Test Workflow"
    )
