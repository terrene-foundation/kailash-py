...
def main():
    ...
    try:
        processor = DataProcessor(data=[1, 2, 3, 4, 5], operation="sum")
    ...
    try:
        processor = DataProcessor(data=[10, 20, 30], operation="average")
        result = processor.execute()
        print(f"✓ Success: {result}\n")
    except Exception as e:
        print(f"✗ Error: {e}\n")
    ...
    try:
        processor = DataProcessor(data=[1, 2, 3], operation="stats")
        result = processor.execute()
    ...
    class SimpleNode(Node):
        ...
        metadata = NodeMetadata(
            name="SimpleNode",
            description="Simple node without output schema"
        )
    ...
    class TypeConversionNode(Node):
        ...
        metadata = NodeMetadata(
            name="TypeConversionNode",
            description="Demonstrates output type conversion"
        )
    ...
    try:
        ...
        print(f"✓ Types converted successfully:")
