    ...
    def manage_in_person_appointment(
        ...
        if schedule_type is None or schedule_type == "RESCH":
            ...
            if (
                ...
                payload_data["passport"] = (
                    passport  # Approximation, system_id might need more specific check
                )
            if (
                passport_exp
                and "malaysia" in system_id.lower()
                ...
                payload_data["passportexp"] = passport_exp  # Approximation
        ...
        if schedule_type == "RESCH":
            if existing_appointment_id:
                ...
                payload_data["appointmentid"] = (
                    existing_appointment_id  # API doc mentions both, let's include both
                )
