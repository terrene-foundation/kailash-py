...
def create_sample_workflow():
    ...
    def transform_data(data: list) -> Dict[str, Any]:
        ...
        for record in data:
            ...
            if isinstance(record.get('income'), (int, float)):
                new_record['income_level'] = 'High' if record['income'] > 100000 else 'Medium'
    ...
    workflow.add_node(node_id='writer', node_or_type=csv_writer, config={
        "file_path": "data/customer_segments.csv"
    })
...
def demonstrate_workflow_execution_and_export():
    ...
    with open("data/customers.csv", 'w') as f:
        ...
        for record in sample_data:
            f.write(f"{record['customer_id']},{record['name']},{record['age']},{record['income']}\n")
...
def main():
    ...
    for dir_path in ["data/exports", "data/exports/minimal", "data/exports/standard",
                     "data/exports/kubernetes", "data/exports/docker"]:
