...
def direct_execution_example():
    ...
    print(
        "In direct execution, nodes run immediately with all parameters provided upfront.\n"
    )
...
def main():
    ...
    # Run both examples
    print(
        "This example shows the difference between direct node execution and workflow execution.\n"
    )
