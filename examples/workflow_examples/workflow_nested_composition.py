...
def create_data_processing_workflow():
    ...
    reader = MockDataGenerator(name="reader", description="Generate mock data")
    ...
    # Use DataLogger instead of CSV writer
    writer = DataLogger(name="writer", description="Log processed data")
