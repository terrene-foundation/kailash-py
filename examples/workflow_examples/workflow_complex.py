...
def create_customer_segmenter():
    ...
    output_schema = {
        "data": NodeParameter(name="data", type=list, required=True),
        "segment_summary": NodeParameter(
            name="segment_summary", type=dict, required=True
        ),
    }
...
def create_report_generator():
    ...
    input_schema = {
        "customer_data": NodeParameter(name="customer_data", type=list, required=True),
        "transaction_metrics": NodeParameter(
            name="transaction_metrics", type=dict, required=True
        ),
    }

    output_schema = {"report": NodeParameter(name="report", type=dict, required=True)}
