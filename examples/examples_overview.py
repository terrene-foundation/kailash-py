...
examples = {
    ...
    "Visualization": [
        ("visualization_example.py", "Workflow visualization options")
    ]
}
...
complexity_levels = {
    ...
    "Intermediate": ["custom_node.py", "data_transformation.py", "visualization_example.py"],
    "Advanced": ["complex_workflow.py", "ai_pipeline.py", "task_tracking_example.py", 
                 "error_handling.py", "export_workflow.py"]
}
complexity_counts = [len(files) for files in complexity_levels.values()]
wedges, texts, autotexts = ax2.pie(complexity_counts, labels=list(complexity_levels.keys()), 
...
plt.tight_layout()
plt.savefig('data/examples_overview.png', dpi=300, bbox_inches='tight')
plt.close()
