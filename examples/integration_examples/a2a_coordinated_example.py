...
def main():
    ...
    result, _ = runtime.execute(
        ...
        parameters={
            "financial_analyst": {
                "messages": [
                    {"role": "user", "content": "Analyze the financial metrics in the Q3 report"}
                ],
    ...
    result, _ = runtime.execute(
        ...
        parameters={
            "market_analyst": {
                "messages": [
                    {"role": "user", "content": "Analyze the market position from the Q3 report"}
                ],
                "memory_pool": memory_pool,
                "provider": "mock",
                "model": "mock-model"
    ...
    result, _ = runtime.execute(
        ...
        parameters={
            "operations_analyst": {
                "messages": [
                    {"role": "user", "content": "Analyze operational metrics from the Q3 report"}
                ],
                "memory_pool": memory_pool,
                "provider": "mock",
                "model": "mock-model"
    ...
    broadcast_result = coordinator.run(
        ...
        message={
            ...
            "target_roles": ["financial_analyst", "market_analyst", "operations_analyst"],
            "priority": "high"
        }
    )
    ...
    collective_insights = memory_pool.run(
        action="read",
