...
def demo_agent_coordination():
    ...
    tasks = [
        ...
        {
            "name": "Research competitive solutions",
...
def demo_attention_mechanism():
    ...
    memories = [
        ...
        ("Routine maintenance completed", ["maintenance", "routine"], 0.3, "operations"),
        ("Customer data breach detected", ["security", "data", "critical"], 0.99, "alerts"),
        ("Weekly report generated", ["report", "routine"], 0.2, "reports"),
        ("Performance optimization achieved 50% speedup", ["performance", "optimization"], 0.8, "improvements"),
