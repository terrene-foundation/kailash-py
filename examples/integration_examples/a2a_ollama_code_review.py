...
Consider security issues as highest priority, followed by performance, then quality.""",
                "attention_filter": {
                    ...
                    "window_size": 50,
                    "preferred_agents": ["security_llama", "performance_mistral", "quality_phi"]
                }
            }
        )
        
        # Connect all reviewers to shared memory
        reviewer_ids = ["security_reviewer", "performance_reviewer", 
                       "quality_reviewer", "lead_reviewer"]
    ...
    def register_reviewers(self):
        ...
        reviewers = [
            {
                "id": "security_llama",
                "skills": ["security_analysis", "vulnerability_detection", "secure_coding"],
    ...
    def review_code(self, code_snippet: str, context: str = "") -> Dict:
        ...
        try:
            ...
            if lead_result.get("lead_reviewer", {}).get("success"):
                ...
                shared_context = lead_result["lead_reviewer"]["a2a_metadata"]["shared_context_used"]
    ...
    def _analyze_review_memory(self, results: Dict):
        ...
        critical_findings = self.memory_pool.run(
            action="read",
            agent_id="analyzer",
            attention_filter={
        ...
        all_findings = self.memory_pool.run(
            action="read",
            agent_id="analyzer",
            attention_filter={
