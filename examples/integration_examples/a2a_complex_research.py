...
class ResearchSystem:
    ...
    def connect_components(self):
        ...
        agent_ids = ["literature_reviewer", "data_collector", "statistical_analyst", "domain_expert", "synthesis_agent"]
    ...
    def register_agents(self) -> Dict[str, bool]:
        ...
        agent_configs = [
            {
                "id": "lit_review_001",
                "skills": ["literature_review", "source_identification", "gap_analysis"],
            ...
            {
                "id": "domain_001",
                "skills": ["climate_science", "domain_validation", "practical_application"],
                "role": "domain_expert"
            },
            {
                "id": "synth_001",
        ...
        for config in agent_configs:
            result = self.coordinator.run(action="register", agent_info=config)
    ...
    def run_research_pipeline(self, research_question: str) -> Dict:
        ...
        print("\n=== PHASE 1: Literature Review ===")
        results["timeline"].append({"phase": "literature_review", "start": time.time() - start_time})
        ...
        results["phases"]["literature_review"] = {
            ...
            "insights": lit_result["literature_reviewer"]["a2a_metadata"]["insights_generated"]
        }
        
        # Phase 2: Data Collection Planning
        print("\n=== PHASE 2: Data Collection Planning ===")
        results["timeline"].append({"phase": "data_collection", "start": time.time() - start_time})
        ...
        results["phases"]["data_collection"] = {
            ...
            "insights": data_result["data_collector"]["a2a_metadata"]["insights_generated"]
        }
        
        # Phase 3: Statistical Analysis Design
        print("\n=== PHASE 3: Statistical Analysis Design ===")
        results["timeline"].append({"phase": "statistical_design", "start": time.time() - start_time})
        ...
        results["phases"]["statistical_design"] = {
            ...
            "insights": stats_result["statistical_analyst"]["a2a_metadata"]["insights_generated"]
        }
        
        # Phase 4: Domain Validation
        print("\n=== PHASE 4: Domain Expert Validation ===")
        results["timeline"].append({"phase": "domain_validation", "start": time.time() - start_time})
        ...
        results["phases"]["domain_validation"] = {
            ...
            "insights": domain_result["domain_expert"]["a2a_metadata"]["insights_generated"]
        }
        
        # Phase 5: Synthesis and Conclusions
        print("\n=== PHASE 5: Research Synthesis ===")
        results["timeline"].append({"phase": "synthesis", "start": time.time() - start_time})
        
        # Query memories for high-importance findings
        key_findings = self.analysis_memory.run(
            action="read",
            agent_id="synth_001",
            attention_filter={
        ...
        results["phases"]["synthesis"] = {
            ...
            "insights": synth_result["synthesis_agent"]["a2a_metadata"]["insights_generated"],
        ...
        for agent_id in ["lit_review_001", "data_collect_001", "stats_001", "domain_001"]:
            self.coordinator.run(
                action="consensus",
        ...
        all_memories = self.general_memory.run(
            action="read",
            agent_id="reporter",
            attention_filter={
        ...
        results["memory_distribution"] = self._analyze_memory_distribution(all_memories["memories"])
    ...
    def _analyze_memory_distribution(self, memories: List[Dict]) -> Dict:
        ...
        for memory in memories:
            ...
            distribution["by_segment"][segment] = distribution["by_segment"].get(segment, 0) + 1
...
def main():
    ...
    for phase, data in results["phases"].items():
        print(f"  - {phase}: {'✓' if data['success'] else '✗'} ({data.get('insights', 0)} insights)")
    ...
    high_importance = system.general_memory.run(
        action="read",
        agent_id="reviewer",
        attention_filter={
            "importance_threshold": 0.8,
