...
| `tests/test-vectors/eatp08-alg-id-canonical.json`  | `serialize_for_signing` (alg_id wire)                                      | Python-authored byte-pin                                                    | kailash-rs VENDORS the file byte-for-byte (parity vector #1315 on the Rust SDK, Rule 4a) |
