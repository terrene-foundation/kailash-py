...
class OptimizerNode(Node):
    ...
    def run(self, context: Dict[str, Any], **kwargs) -> Dict[str, Any]:
        ...
        print(f"[Iteration {iteration}] Score: {score:.3f} → {new_score:.3f}, Converged: {converged}")
...
def test_switch_cycle():
    ...
    def package_for_switch(score: float = 0.5, converged: bool = False, iteration: int = 0, data: Dict = None) -> Dict[str, Any]:
    ...
    results, _ = runtime.execute(
        workflow,
        parameters={"optimizer": {"score": 0.5, "improvement_rate": 0.15}}
    )
