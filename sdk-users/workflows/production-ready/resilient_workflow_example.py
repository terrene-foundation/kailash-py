...
def demonstrate_enterprise_patterns():
    ...
    workflow2 = ResilientWorkflow(
        workflow_id="graceful_degradation",
    ...
    workflow2.add_node("basic_analysis", LLMAgentNode, model="gpt-3.5-turbo", max_tokens=500)
    ...
    workflow2.add_node(
        ...
        PythonCodeNode.from_function(
            ...
            func=lambda text: {"analysis": "Basic rule-based analysis", "confidence": 0.5}
        )
    )
...
if __name__ == "__main__":
    ...
    print("   Just use @apply_resilience_to_workflow decorator or configure on standard Workflow")