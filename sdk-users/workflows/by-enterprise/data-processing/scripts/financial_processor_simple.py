...
def create_financial_processor_workflow() -> Workflow:
    ...
    workflow.connect("valid_filter", "value_router", mapping={"filtered_data": "input_data"})
    ...
    workflow.connect("value_router", "result_writer", 
...
TX005,100000,USD,ACC-33333,85"""
    ...
    parameters = {
        ...
        "result_writer": {
            "file_path": "/tmp/processed_transactions.csv"
        }
    }
    ...
    try:
        ...
        print(f"  Processed transactions written to: /tmp/processed_transactions.csv")
        print()
