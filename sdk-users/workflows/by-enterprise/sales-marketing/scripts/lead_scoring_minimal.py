...
LEAD005,BigCo,Manufacturing,10000,67"""
    ...
    # Create workflow
    workflow = Workflow(
        workflow_id="lead_scoring_minimal",
        name="minimal_lead_demo"
    )
    ...
    workflow.connect("reader", "writer", mapping={"data": "data"})  # Write original data
    ...
    try:
        ...
        print(f"  Scored leads written to: /tmp/scored_leads.csv")
        print()
