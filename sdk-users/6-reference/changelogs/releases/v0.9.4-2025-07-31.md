...
```python
# Before: Failed with "invalid literal for int() with base 10: 'SecureP@ss12'"
connection_string = "postgresql://admin:SecureP@ss123!@localhost:6432/db"
...
password = "SecureP%40ss123%21"  # %40 = @, %21 = !
