...
```python
# Before: Failed with "invalid literal for int() with base 10: 'REDACTED'"
connection_string = "postgresql://admin:REDACTED#$@localhost:6432/db"
