# v0.9.19 - Provider Registry Fix & Multi-Modal Support
...
**Before v0.9.19**: Custom mock providers were bypassed by hardcoded logic
**After v0.9.19**: Custom mock providers work through proper registry
...
**PyPI**: https://pypi.org/project/kailash/0.9.19/
**GitHub Tag**: `core-sdk-v0.9.19`
