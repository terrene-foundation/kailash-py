...
The current version is **0.9.7** (released 2025-07-31).

## Recent Releases

- [v0.9.7 - 2025-07-31](releases/v0.9.7-2025-07-31.md) - IterativeLLMAgentNode MCP Fallback & Performance Optimizations
- [v0.9.6 - 2025-01-31](releases/v0.9.6-2025-01-31.md) - IterativeLLMAgentNode Fallback Architecture & W8 Serialization
