...
"""
    ...
    async def test_distributed_transaction_coordination(self):
        ...
        workflow.add_node("EdgeCoordinationNode", "start_transaction", {
            "operation": "propose",
        ...
        # Prepare phase
        workflow.add_node("PythonCodeNode", "prepare_transaction", {
            "code": """
...
"""
        ...
        workflow.add_node("EdgeCoordinationNode", "coordinate_commit", {
            "operation": "propose",
            "coordination_group": "transaction_managers"
        })
        
        # Global ordering for transaction log
        workflow.add_node("EdgeCoordinationNode", "order_transaction", {
            "operation": "global_order",
            "coordination_group": "transaction_managers"
        })
        
        # Connect nodes - EdgeCoordinationNode outputs 'success', not 'accepted'
        workflow.add_connection("start_transaction", "success", "prepare_transaction", "tx_info")
        workflow.add_connection("prepare_transaction", "result", "coordinate_commit", "proposal")
        workflow.add_connection("coordinate_commit", "success", "order_transaction", "events")
