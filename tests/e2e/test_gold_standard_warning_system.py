...
class TestGoldStandardWarningSystemE2E:
    ...
    def test_sdk_node_string_pattern_warning(self):
        ...
        assert "String references work for all @register_node() decorated SDK nodes" in warning
    ...
    def test_production_workflow_mixed_nodes(self):
        ...
        self.workflow.add_node(DataTransformerNode, "transformer", {
    ...
    def test_workflow_execution_with_warnings(self):
        ...
        self.workflow.add_node("PythonCodeNode", "generator", {
            "code": "result = {'numbers': list(range(5))}"
        })
        self.workflow.add_node(ProcessorNode, "processor")
        self.workflow.connect("generator", "processor", mapping={"result.numbers": "data"})
...
""")
    ...
    def test_nested_workflow_warning_propagation(self):
        ...
        self.workflow.add_node("WorkflowNode", "nested", {
    ...
    def test_production_deployment_validation(self):
        ...
        self.workflow.add_node(AuthenticationNode, "auth", {
            "auth_type": "oauth2"
        })
    ...
    def test_warning_message_quality_and_helpfulness(self):
        ...
        self.workflow.add_node(ModelTrainerNode, "trainer", {
    ...
    def test_batch_workflow_creation_warnings(self):
        ...
        for i in range(10):
            if i % 2 == 0:
                ...
                self.workflow.add_node(LoggerNode, f"logger_{i}", {
                    "log_level": "INFO"
                })
...
class TestWarningSystemIntegration:
    ...
    def test_warning_with_validation_framework(self):
        ...
        with warnings.catch_warnings(record=True) as w:
            ...
            custom_warnings = [m for m in warning_messages if "Custom node detected" in m]
    ...
    def test_warning_with_performance_monitoring(self):
        ...
        class SlowNode(Node):
            def get_parameters(self):
                return {
                    "delay": NodeParameter(name="delay", type=float, required=True)
                }
