...
class TestPhase4CostOptimizer:
    ...
    def test_cost_optimizer_enums(self):
        ...
        from kailash.edge.resource import CloudProvider, InstanceType, OptimizationStrategy
        
        assert CloudProvider.AWS.value == "aws"
        assert CloudProvider.GCP.value == "gcp"
        assert InstanceType.ON_DEMAND.value == "on_demand"
        assert InstanceType.SPOT.value == "spot"
        assert OptimizationStrategy.BALANCE_COST_PERFORMANCE.value == "balance_cost_performance"
