...
from kailash.trust.chain_store.filesystem import file_lock, validate_id
...
class TestFileLockCrossProcess:
    ...
    def test_exclusive_lock_blocks_second_process(self, tmp_path):
        ...
        child_script = textwrap.dedent(
            ...
            from kailash.trust.chain_store.filesystem import file_lock
...
class TestFileLockPublicAPI:
    ...
    def test_file_lock_importable_from_filesystem(self):
        """file_lock must be importable from kailash.trust.chain_store.filesystem."""
        from kailash.trust.chain_store.filesystem import file_lock as fl

        assert callable(fl)

    def test_validate_id_importable_from_filesystem(self):
        """validate_id must be importable from kailash.trust.chain_store.filesystem."""
        from kailash.trust.chain_store.filesystem import validate_id as vi
