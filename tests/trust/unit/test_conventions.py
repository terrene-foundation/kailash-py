...
# Root of the trust package source (was eatp, now kailash.trust)
_EATP_SRC = (
    Path(__file__).resolve().parent.parent.parent.parent / "src" / "kailash" / "trust"
)
...
_SAFE_PATTERNS = {
    ...
    r"\.value ==",
    r"\.name ==",
    # JavaScript strict equality (=== in embedded JS templates) is not Python
    r"===",
}
