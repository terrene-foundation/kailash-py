...
class TestAWSKMSKeyManagerInit:
    ...
    def test_init_without_boto3_raises_import_error(self):
        ...
        with patch("kailash.trust.key_manager.BOTO3_AVAILABLE", False):
    ...
    def test_init_creates_default_client_when_boto3_available(self):
        ...
        with patch("kailash.trust.key_manager.BOTO3_AVAILABLE", True):
            with patch("kailash.trust.key_manager.boto3") as mock_boto3:
