...
from kailash.mcp_server.subscriptions import ResourceSubscriptionManager, ResourceChange, ResourceChangeType
...
class TestGraphQLFieldSelectionIntegration(DockerIntegrationTestBase):
    ...
    @pytest.mark.asyncio
    async def test_resource_change_processing_with_field_selection(self, subscription_manager):
        """Test processing resource changes with field selection applied."""
        # Track notifications
        notifications = []
        
        async def notification_handler(connection_id: str, notification: Dict[str, Any]):
    ...
    @pytest.mark.asyncio
    async def test_fragment_processing_with_resource_changes(self, subscription_manager):
    ...
    @pytest.mark.asyncio
    async def test_multiple_subscriptions_different_field_selections(self, subscription_manager):
