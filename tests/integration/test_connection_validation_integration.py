...
"""
    ...
    def test_switch_node_conditional_validation(self):
        ...
        workflow.add_node("PythonCodeNode", "source", {
            "code": "result = {'value': 42, 'flag': True}"
        })
...
"""
    ...
    def test_nested_workflow_validation(self):
        ...
        inner_workflow.add_node("PythonCodeNode", "validator", {
            "code": """
...
"""
        ...
        outer_workflow.add_node("PythonCodeNode", "source", {
            "code": """
...
"""
        ...
        outer_workflow.add_node("WorkflowNode", "inner", {
        ...
        outer_workflow.add_connection("source", "result.workflow_inputs", "inner", "inputs")
...
"""
        ...
        for i in range(3):
            workflow.add_connection(f"processor_{i}", "result", "aggregator", f"input_{i}")
        ...
        assert len(results["aggregator"]["result"]["aggregated"]) == 15  # 5 numbers * 3 processors
