...
from kailash.workflow.validation import ParameterDeclarationValidator, IssueSeverity, ValidationIssue
...
class TestParameterValidationProduction:
    ...
    def test_undeclared_parameters_detection(self):
        ...
        workflow.add_node(PartialParamsNode, "processor", {
            "input_data": [1, 2, 3],
    ...
    def test_missing_required_parameters(self):
        ...
        workflow.add_node(RequiredParamsNode, "processor", {
            "user_id": "user123"
    ...
    def test_cyclic_workflow_parameter_validation(self):
        ...
        workflow.add_node(IterativeProcessorNode, "processor", {
            "data": [10, 20, 30],
            "threshold": 0.9
        })
    ...
    def test_validation_error_aggregation(self):
        ...
        workflow.add_node(ProblematicNode, "problem", {
            "param1": "value1",
        ...
        workflow.add_node(ProblematicNode, "problem2", {
        ...
        assert "undeclared" in error_message.lower() or "not declared" in error_message.lower()
