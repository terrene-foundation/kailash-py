...
class AccessControlTestUtils:
    ...
    def create_test_permission_rule(
        ...
        **kwargs
        ...
        effect_enum = PermissionEffect.ALLOW if effect == "allow" else PermissionEffect.DENY
    ...
    def create_rbac_test_scenario():
        ...
        manager.add_rule(AccessControlTestUtils.create_test_permission_rule(
            "admin_all_access",
            effect="allow",
            role="admin"
        ))
