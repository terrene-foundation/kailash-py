...
from kailash.nodes.api.graphql import GraphQLClientNode, AsyncGraphQLClientNode
from kailash.nodes.api.auth import BasicAuthNode, OAuth2Node, APIKeyNode
...
class TestGraphQLClientNode:
    ...
    def test_build_graphql_payload(self):
        ...
        assert payload["query"] == "query GetUser($id: ID!) { user(id: $id) { id name } }"
...
class TestAuthNodes:
    ...
    def test_oauth2_client_credentials(self):
        ...
        assert result["token_data"]["access_token"] == "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..."
