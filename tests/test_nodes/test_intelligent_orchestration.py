...
class TestIntelligentCacheNode:
    ...
    def test_semantic_search(self):
        ...
        cache.run(
            ...
            metadata={
                "semantic_tags": ["weather", "temperature", "conditions"]
            }
        )
...
class TestConvergenceDetectorNode:
    ...
    def test_quality_threshold_met(self):
        ...
        solution_history = [
            {"evaluation": {"overall_score": 0.85}, "duration": 60}
        ]
    ...
    def test_iteration_limit(self):
        ...
        solution_history = [
            {"evaluation": {"overall_score": 0.6}, "duration": 60}
        ]
    ...
    def test_improvement_trend_calculation(self):
        ...
        result = detector.run(
            solution_history=improving_history,
            current_iteration=3
        )
