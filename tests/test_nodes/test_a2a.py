...
class TestA2ACoordinatorNode:
    ...
    def test_broadcast_message(self):
        ...
        coordinator.run(
            action="register",
            agent_info={"id": "agent3", "role": "researcher", "skills": ["research", "writing"]}
        )
    ...
    def test_consensus_management(self):
        ...
        # Should have consensus (2 yes, 1 no out of 4 agents = majority)
    ...
    def test_workflow_coordination(self):
        ...
        workflow = {
            ...
            "steps": [
                ...
                {
                    "name": "evaluate",
                    "required_skills": ["modeling", "analysis"]
                }
            ]
        }
