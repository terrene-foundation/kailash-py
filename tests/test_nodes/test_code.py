...
from kailash.nodes.code import PythonCodeNode, FunctionWrapper, ClassWrapper, CodeExecutor
from kailash.sdk_exceptions import NodeExecutionError, NodeConfigurationError, NodeValidationError
...
""")
    ...
    def test_input_validation(self):
        ...
        with pytest.raises(NodeValidationError, match="Required input 'y' not provided"):
            node.execute(x=5)
