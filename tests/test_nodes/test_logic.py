...
from kailash.nodes.logic.async_operations import AsyncSwitch, AsyncMerge
...
class TestLogicNodeValidation:
    ...
    def test_switch_missing_input_data(self):
        ...
        with pytest.raises(NodeExecutionError, match="Required parameter 'input_data' not provided"):
            node.execute()
    ...
    async def test_async_switch_missing_input(self):
        ...
        with pytest.raises(ValueError, match="Required parameter 'input_data' not provided"):
