...
class TestMergeNode:
    ...
    def test_concat_lists(self):
        ...
        node = Merge(data1=[1, 2, 3], data2=[4, 5, 6], merge_type="concat")
    ...
    def test_concat_mixed_types(self):
        ...
        node = Merge(data1="hello", data2="world", merge_type="concat")
    ...
    def test_zip_merge(self):
        """Test zip merging."""
        node = Merge(data1=[1, 2, 3], data2=["a", "b", "c"], merge_type="zip")
    ...
    def test_multiple_data_sources(self):
        ...
        node = Merge(data1=[1, 2], data2=[3, 4], data3=[5, 6], merge_type="concat")
    ...
    def test_single_input(self):
        ...
        node = Merge(data1=[1, 2, 3], merge_type="concat")
    ...
    def test_unknown_merge_type(self):
        ...
        node = Merge(data1=[1, 2, 3], data2=[4, 5, 6])
...
class TestAsyncMergeNode:
    ...
    async def test_async_concat(self):
        ...
        node = AsyncMerge(data1=[1, 2, 3], data2=[4, 5, 6], merge_type="concat")
    ...
    async def test_async_zip(self):
        ...
        node = AsyncMerge(data1=[1, 2, 3], data2=["x", "y", "z"], merge_type="zip")
...
class TestLogicNodeValidation:
    ...
    def test_switch_missing_input_data(self):
        ...
        node = Switch(condition_field="status", operator="==", value="success")
...
class TestLogicNodeEdgeCases:
    ...
    def test_merge_empty_lists(self):
        ...
        node = Merge(data1=[], data2=[], merge_type="concat")
