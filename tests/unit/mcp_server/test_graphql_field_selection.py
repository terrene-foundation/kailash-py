...
from kailash.mcp_server.subscriptions import ResourceSubscription, ResourceSubscriptionManager
...
class TestGraphQLFieldSelection:
    ...
    def test_extract_field_value_nested(self):
        ...
        assert subscription._extract_field_value(data, "metadata.modified") == "2024-01-01T00:00:00Z"
    ...
    @pytest.mark.asyncio
    async def test_process_resource_change_with_field_selection(self, subscription_manager):
        ...
        # Mock resource data
        subscription_manager._get_resource_data = AsyncMock(return_value={
            "uri": "file:///document.json",
            "name": "document",
            "content": {
                "text": "Hello world",
