...
class TestHybridRetrieverNode:
    ...
    def test_rrf_fusion_strategy(self):
        ...
        dense_results = [
            {"id": "doc1", "content": "AI and machine learning", "similarity_score": 0.9},
            {"id": "doc2", "content": "Natural language processing", "similarity_score": 0.8},
            {"id": "doc3", "content": "Computer vision systems", "similarity_score": 0.7},
        ]
        
        sparse_results = [
            {"id": "doc2", "content": "Natural language processing", "similarity_score": 0.85},
            {"id": "doc4", "content": "Data science methods", "similarity_score": 0.75},
            {"id": "doc1", "content": "AI and machine learning", "similarity_score": 0.65},
        ]
    ...
    def test_empty_results_handling(self):
        ...
        result = node.execute(query="test", dense_results=dense_results, sparse_results=[])
    ...
    def test_result_normalization(self):
        ...
        dense_results = [
            {"chunk_id": "chunk1", "text": "content1", "score": 0.9},  # Different field names
        ]
        sparse_results = [
            {"id": "doc2", "content": "content2", "similarity_score": 0.8},  # Standard names
        ]
    ...
    def test_unsupported_fusion_strategy(self):
        ...
        assert result["fusion_method"] == "invalid_strategy"  # Reports what was requested
        assert len(result["hybrid_results"]) <= 2