    ...
    async def test_async_output_validation_with_ports(self):
        ...
        class AsyncOutputValidationNode(AsyncTypedNode):
            ...
            async def async_run(self, **kwargs):
                ...
                return {"result": "hello", "count": "42"}  # count will be converted to int
...
class TestAsyncTypedNodeAdvancedFeatures:
    ...
    async def test_complex_async_operations(self):
        ...
        class ComplexAsyncNode(AsyncTypedNode):
            ...
            timeout = InputPort[float]("timeout", default=1.0, description="Request timeout")
            results = OutputPort[Dict[str, Any]]("results", description="Processing results")
    ...
    async def test_async_error_handling(self):
        ...
        class AsyncErrorTestNode(AsyncTypedNode):
            should_fail = InputPort[bool]("should_fail", default=False, description="Whether to fail")
    ...
    async def test_convenience_port_types_async(self):
        ...
        result = await node.execute_async(text="hello", count="5")  # Should convert string to int
        assert result["count"] == 5
...
class TestAsyncTypedNodeBackwardCompatibility:
    ...
    async def test_traditional_parameter_access_async(self):
        ...
        result = await node.execute_async(port_input="port_data", traditional_param="traditional_data")
...
class TestAsyncTypedNodeIntegration:
    ...
    def test_async_node_serialization(self):
        ...
        node = SerializableAsyncNode(name="TestAsyncNode", description="Test async node")
