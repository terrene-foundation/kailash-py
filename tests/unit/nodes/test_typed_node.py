...
class TestTypedNodeBasics:
    ...
    def test_simple_typed_node_creation(self):
        ...
        class SimpleTypedNode(TypedNode):
            ...
            result_output = OutputPort[str]("result_output", description="Result output")
    ...
    def test_get_parameters_from_ports(self):
        ...
        class ParameterTestNode(TypedNode):
            ...
            optional_count = InputPort[int]("optional_count", default=1, required=False, description="Optional count")
...
class TestTypedNodeValidation:
    ...
    def test_input_validation_with_ports(self):
        ...
        class ValidationTestNode(TypedNode):
            ...
            optional_input = InputPort[str]("optional_input", required=False, description="Optional")
        ...
        with pytest.raises(NodeValidationError, match="Required parameter 'text_input' not provided"):
            node.validate_inputs(number_input=42)
        
        # Test optional parameter
        validated = node.validate_inputs(text_input="hello", number_input=42, optional_input=None)
    ...
    def test_output_validation_with_ports(self):
        ...
        with pytest.raises(NodeValidationError, match="Output 'count' must be of type int"):
    ...
    def test_port_constraints_validation(self):
        ...
        class ConstraintTestNode(TypedNode):
            ...
            number_input = InputPort[int]("number_input",
...
class TestTypedNodeExecution:
    ...
    def test_typed_node_execution_flow(self):
        ...
        class ExecutionTestNode(TypedNode):
            ...
            multiplier = InputPort[int]("multiplier", default=2, description="Multiplier")
...
class TestTypedNodeBackwardCompatibility:
    ...
    def test_traditional_parameter_access(self):
        ...
        result = node.execute(port_input="port_data", traditional_param="traditional_data")
...
class TestTypedNodeAdvancedFeatures:
    ...
    def test_complex_type_support(self):
        ...
        class ComplexTypeNode(TypedNode):
            string_list = InputPort[List[str]]("string_list", description="List of strings")
            optional_data = InputPort[Optional[str]]("optional_data", required=False, description="Optional string")
            union_input = InputPort[Union[str, int]]("union_input", description="String or int")
            dict_data = InputPort[Dict[str, Any]]("dict_data", description="Dictionary data")
            ...
            def run(self, **kwargs):
                return {
                    "result": {
                        ...
                        "optional_provided": self.optional_data.get() is not None if hasattr(self.optional_data, '_value') and self.optional_data._value is not None else False,
    ...
    def test_port_schema_generation(self):
        ...
        class SchemaNode(TypedNode):
            input1 = InputPort[str]("input1", description="First input", 
                                  constraints={"min_length": 1}, examples=["example1"])
    ...
    def test_enhanced_serialization(self):
        ...
        class SerializationNode(TypedNode):
            ...
            output_param = OutputPort[int]("output_param", description="Output parameter")
...
class TestErrorHandling:
    ...
    def test_port_validation_errors(self):
        ...
        with pytest.raises(NodeValidationError, match="Input 'strict_input' must be of type int"):
    ...
    def test_port_access_errors(self):
        ...
        class AccessErrorNode(TypedNode):
            required_input = InputPort[str]("required_input", description="Required input")
        ...
        with pytest.raises(NodeValidationError, match="Required parameter 'required_input' not provided"):
