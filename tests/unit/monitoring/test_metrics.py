...
from kailash.monitoring.metrics import (
    MetricType, MetricSeverity, MetricPoint, MetricSeries, MetricsCollector,
    ValidationMetrics, SecurityMetrics, PerformanceMetrics, MetricsRegistry,
    get_metrics_registry, get_validation_metrics, get_security_metrics,
...
class TestValidationMetrics:
    ...
    def test_record_validation_attempt(self):
        ...
        metrics.record_validation_attempt("TestNode", success=True, duration_ms=25.5, cached=False)
        ...
        metrics.record_validation_attempt("OtherNode", success=False, duration_ms=5.0, cached=True)
    ...
    def test_get_cache_hit_rate(self):
        ...
        # Record some validations
        metrics.record_validation_attempt("Node1", success=True, duration_ms=10.0, cached=True)
        metrics.record_validation_attempt("Node2", success=True, duration_ms=15.0, cached=True)
        metrics.record_validation_attempt("Node3", success=False, duration_ms=20.0, cached=False)
...
class TestSecurityMetrics:
    ...
    def test_record_different_violation_types(self):
        ...
        metrics.record_security_violation("code_injection", MetricSeverity.HIGH, "PythonNode")
        metrics.record_security_violation("path_traversal", MetricSeverity.MEDIUM, "FileNode")
        metrics.record_security_violation("credential_exposure", MetricSeverity.CRITICAL, "APINode")
        ...
        assert metrics.get_metric("credential_exposure_attempts").get_latest_value() == 1
    ...
    def test_record_blocked_connection(self):
        ...
        metrics.record_blocked_connection("malicious_input", "database", "SQL injection detected")
    ...
    def test_get_violation_rate(self):
        ...
        time.sleep(0.01)
        metrics.record_security_violation("code_injection", MetricSeverity.CRITICAL, "Node2")
    ...
    def test_get_critical_violations(self):
        ...
        metrics.record_security_violation("sql_injection", MetricSeverity.CRITICAL, "Node1")
        metrics.record_security_violation("code_injection", MetricSeverity.MEDIUM, "Node2")
        metrics.record_security_violation("path_traversal", MetricSeverity.CRITICAL, "Node3")
...
class TestMetricsIntegration:
    ...
    def test_security_monitoring_flow(self):
        ...
        metrics.record_security_violation("sql_injection", MetricSeverity.CRITICAL, "DB1")
        metrics.record_blocked_connection("malicious", "target", "blocked")
        metrics.record_security_violation("code_injection", MetricSeverity.HIGH, "Code1")
