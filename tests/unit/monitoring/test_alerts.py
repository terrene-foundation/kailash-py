...
from kailash.monitoring.alerts import (
    AlertSeverity, AlertStatus, Alert, AlertRule, AlertManager,
    NotificationChannel, LogNotificationChannel, EmailNotificationChannel,
    SlackNotificationChannel, WebhookNotificationChannel,
    create_default_alert_rules
)
from kailash.monitoring.metrics import MetricSeries, MetricType, MetricsRegistry, ValidationMetrics
...
class TestAlert:
    ...
    def test_alert_fire(self):
        ...
        alert = Alert("test", "rule", AlertSeverity.WARNING, "Test Alert", "Test description")
...
class TestAlertRule:
    ...
    def test_rule_evaluation_greater_than(self):
        ...
        assert rule.evaluate(series) == True
        
        series.add_point(5)  # Below threshold
        assert rule.evaluate(series) == False
...
class TestLogNotificationChannel:
    ...
    def test_log_notification(self, mock_logger):
        ...
        alert = Alert("test", "rule", AlertSeverity.CRITICAL, "Test Alert", "Critical issue")
...
class TestEmailNotificationChannel:
    ...
    def test_email_notification_success(self):
        ...
        alert = Alert("test", "rule", AlertSeverity.ERROR, "Test Alert", "Error occurred")
...
class TestSlackNotificationChannel:
    ...
    def test_slack_notification_success(self, mock_post):
        ...
        alert = Alert("test", "rule", AlertSeverity.WARNING, "Test Alert", "Warning message")
    ...
    def test_slack_notification_failure(self, mock_post):
        ...
        alert = Alert("test", "rule", AlertSeverity.ERROR, "Test Alert", "Error message")
        context = {}
...
class TestAlertManager:
    ...
    def test_get_active_alerts(self):
        ...
        alert1 = Alert("alert1", "rule1", AlertSeverity.ERROR, "Alert 1", "Description 1")
        alert1.fire()
        
        alert2 = Alert("alert2", "rule2", AlertSeverity.WARNING, "Alert 2", "Description 2")
        alert2.fire()
        alert2.resolve()
    ...
    def test_silence_alert(self):
        ...
        alert = Alert("test_alert", "rule", AlertSeverity.WARNING, "Test", "Description")
        alert.fire()
    ...
    def test_notification_sending(self, mock_logger):
        ...
        alert = Alert("test_alert", "rule", AlertSeverity.CRITICAL, "Critical Alert", "Critical issue")
        alert.fire()
        self.alert_manager.alerts["test_alert"] = alert
...
class TestAlertIntegration:
    ...
    def test_end_to_end_alerting_flow(self):
        ...
        validation_metrics.record_validation_attempt("Node4", False, 25.0)  # Triggers alert
    ...
    def test_multiple_rules_and_channels(self):
        ...
        with patch('kailash.monitoring.alerts.requests.post') as mock_post:
            ...
            # Trigger alerts
            validation_metrics.increment("validation_failure", 10)  # Triggers both rules
