...
from kailash.nodes.ai.a2a import A2AAgentCard, CapabilityLevel, CollaborationStyle, Capability, PerformanceMetrics
...
class TestContextualScorer:
    ...
    def test_calculate_context_score(self):
        ...
        context = SearchContext(
            ...
            recent_interactions={
                "agent1": datetime.now() - timedelta(days=1)
            },
            domain_expertise={
                "agent1": ["python", "testing", "automation"]
            },
    ...
    def test_recency_score(self):
        ...
        context = SearchContext(
            recent_interactions={
                "agent1": datetime.now() - timedelta(hours=1)
            }
        )
        ...
        context = SearchContext(
            recent_interactions={
                "agent1": datetime.now() - timedelta(days=7)
            }
        )
        score = scorer._calculate_recency_score("agent1", context)
        assert score == 0.8
...
class TestHybridSearchNode:
    ...
    async def test_basic_search(self):
        ...
        agents = [
            {"agent_id": "agent1", "description": "Python developer with testing experience"},
            {"agent_id": "agent2", "description": "Java developer with database skills"},
    ...
    async def test_search_with_context(self):
        ...
        context = {
            ...
            "recent_interactions": {
                "agent1": datetime.now().isoformat()
            },
            "domain_expertise": {
                "agent1": ["python", "testing"]
            }
        }
...
class TestAdaptiveSearchNode:
    ...
    def test_learn_from_feedback(self):
        ...
        total_weight = (node.semantic_weight + node.keyword_weight + 
                       node.context_weight + node.performance_weight)
