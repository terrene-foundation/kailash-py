...
class TestConnectionContract:
    ...
    def test_security_policy_enforcement(self):
        ...
        is_compliant, violation = contract.check_security_policies("SELECT * FROM users")
    ...
    def test_credentials_detection(self):
        ...
        # Credential data
        is_compliant, violation = contract.check_security_policies("password: secret123")
        assert not is_compliant
