...
class TestParameterDeclarationValidator:
    ...
    def test_empty_parameters_with_workflow_config(self):
        ...
        assert "enterprise-parameter-passing-gold-standard.md" in issue.documentation_link
    ...
    def test_undeclared_parameters_warning(self):
        ...
        assert "not declared in get_parameters() - will be ignored by SDK" in issue.message
    ...
    def test_missing_required_parameter(self):
        ...
        assert "Required parameter 'input_text' not provided by workflow" in issue.message
