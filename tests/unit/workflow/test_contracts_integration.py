...
from kailash.workflow.contracts import ConnectionContract, SecurityPolicy, get_contract_registry
from kailash.sdk_exceptions import WorkflowValidationError, ConnectionError
...
class TestContractIntegration:
    ...
    def test_add_typed_connection_unknown_contract(self):
        ...
        with pytest.raises(WorkflowValidationError, match="Contract 'unknown_contract' not found"):
            builder.add_typed_connection(
                "source", "result", "target", "data",
    ...
    def test_add_typed_connection_missing_nodes(self):
        ...
        with pytest.raises(WorkflowValidationError, match="Source node 'missing' not found"):
            builder.add_typed_connection(
                "missing", "result", "target", "data",
                contract="string_data"
            )
    ...
    def test_list_connection_contracts(self):
        ...
        builder.add_typed_connection("node1", "result", "node2", "data", contract="string_data")
        builder.add_typed_connection("node2", "result", "node3", "data", contract="numeric_data")
    ...
    def test_mixed_connections_with_and_without_contracts(self):
        ...
        # Add typed connection
        builder.add_typed_connection("node2", "result", "node3", "data", contract="string_data")
...
class TestContractValidationMethods:
    ...
    def test_connection_id_format(self):
        ...
        builder.add_typed_connection(
            "source_node", "output_port", "target_node", "input_port",
            contract="string_data"
        )
    ...
    def test_fluent_api_chaining_with_contracts(self):
        ...
        result = builder.add_typed_connection("source", "result", "target", "data", contract="string_data")
