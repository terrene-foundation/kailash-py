...
from kailash.workflow.type_inference import (
    TypeInferenceEngine, TypeCompatibilityResult, ConnectionInferenceResult,
    CoercionRule, check_connection_compatibility, validate_workflow_connections,
...
class TestUnionTypes:
    ...
    def test_union_target_compatibility(self):
        ...
        result = engine.check_compatibility(float, Union[str, int], allow_coercion=False)
...
class TestGenericTypes:
    ...
    def test_generic_origin_mismatch(self):
        ...
        result = engine.check_compatibility(List[str], tuple)  # Note: using base tuple type
...
class TestPortCompatibility:
    ...
    def test_port_type_incompatibility(self):
        ...
        result = engine.infer_connection_type(output_port, input_port, allow_coercion=False)
