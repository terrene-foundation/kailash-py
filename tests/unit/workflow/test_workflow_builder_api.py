...
class TestWorkflowBuilderUnification:
    ...
    def test_add_node_with_class_reference(self):
        ...
        with pytest.warns(UserWarning, match="((SDK node detected|CUSTOM NODE USAGE CORRECT)|CUSTOM NODE USAGE CORRECT)"):
    ...
    def test_add_node_auto_id_generation(self):
        ...
        # Class reference
        with pytest.warns(UserWarning, match="(SDK node detected|CUSTOM NODE USAGE CORRECT)"):
            builder.add_node(MockNode)
...
class CustomUnregisteredNode(Node):
    ...
    def get_parameters(self):
        return {
            "test_param": NodeParameter(type=str, required=False, default="custom")
        }
...
class TestEnhancedWarningSystem:
    ...
    def test_sdk_node_warning_suggests_string_pattern(self):
        ...
        assert is_sdk_warning or is_custom_warning, f"Expected SDK or custom node warning, got: {warning_message}"
    ...
    def test_custom_node_warning_confirms_correct_usage(self):
        ...
        with pytest.warns(UserWarning) as warning_info:
            builder.add_node(CustomUnregisteredNode, "test_node", {"test_param": "value"})
    ...
    def test_generate_intelligent_warning_for_sdk_node(self):
        ...
        assert is_sdk_warning or is_custom_warning, f"Expected SDK or custom node warning, got: {warning}"
    ...
    def test_generate_intelligent_warning_for_custom_node(self):
        ...
        warning = builder._generate_intelligent_node_warning(CustomUnregisteredNode, "test_id")
