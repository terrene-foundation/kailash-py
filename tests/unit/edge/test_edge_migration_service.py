...
class TestEdgeMigrationServiceSingleton:
    ...
    def test_singleton_behavior(self, migration_config):
        ...
        assert service1._config["checkpoint_interval"] == migration_config["checkpoint_interval"]
        assert service1._config["max_concurrent_migrations"] == migration_config["max_concurrent_migrations"]
    ...
    @pytest.mark.asyncio
    async def test_async_migration_operations(self, migration_config, sample_migration_plan):
