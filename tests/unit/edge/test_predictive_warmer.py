...
class TestPredictiveWarmer:
    ...
    async def test_time_series_prediction(self, warmer, sample_patterns):
        ...
        with patch('kailash.edge.prediction.predictive_warmer.datetime') as mock_datetime:
            ...
            if len(decisions) == 0:
                ...
                morning_patterns = [p for p in warmer.usage_history if p.timestamp.hour == 9]
    ...
    async def test_geographic_prediction(self, warmer, sample_patterns):
        ...
        if len(decisions) == 0:
            ...
            for location, patterns in location_patterns.items():
                ...
                print(f"Debug: location {location} has {len(recent_patterns)} recent patterns")
