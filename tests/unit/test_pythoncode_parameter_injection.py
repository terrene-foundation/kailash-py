...
""",
    ...
    assert result["result"]["workflow_param"] == "extra"
...
def test_function_parameter_injection():
    ...
    assert result["result"]["result"] == "test: 15"
...
"""
    ...
    assert results["receiver"]["result"]["node_param"] == "node_value"
    assert results["receiver"]["result"]["workflow_param"] == "workflow_value"
    assert results["receiver"]["result"]["extra_param"] == "extra_value"
