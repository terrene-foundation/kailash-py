...
class BaseAgentConfig:
    """
    Universal configuration for BaseAgent (minimal version for testing).

    Full implementation should match ADR-006 specification:
    - LLM Provider Configuration (llm_provider, model, temperature, max_tokens)
    - Framework Features (signature_programming_enabled, optimization_enabled, monitoring_enabled)
    - Agent Behavior (logging_enabled, performance_enabled, error_handling_enabled, batch_processing_enabled)
...
class TestBaseAgentBasicCreation:
    ...
    def test_minimal_config_creation(self):
        ...
        # Expected import: from kaizen.core.base_agent import BaseAgent
