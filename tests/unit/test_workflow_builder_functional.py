...
class TestWorkflowBuilderNodeAddition:
    ...
    def test_add_node_current_api_pattern(self):
        ...
        try:
            ...
            assert builder.nodes["api_call"]["type"] == "HTTPRequestNode"
            assert (
                builder.nodes["api_call"]["config"]["url"] == "https://api.example.com"
            )
            assert builder.nodes["api_call"]["config"]["method"] == "GET"
    ...
    def test_add_node_auto_id_generation(self):
        ...
        try:
            ...
            assert builder.nodes[node_id]["type"] == "CSVReaderNode"
            assert builder.nodes[node_id]["config"]["file_path"] == "data.csv"
    ...
    def test_add_node_keyword_only_pattern(self):
        ...
        try:
            ...
            assert builder.nodes["db_query"]["type"] == "DatabaseNode"
            assert builder.nodes["db_query"]["config"]["query"] == "SELECT * FROM users"
            ...
            assert builder.nodes["email_sender"]["config"]["subject"] == "Test"
            assert builder.nodes["email_sender"]["config"]["to"] == "test@example.com"
            assert builder.nodes["email_sender"]["config"]["body"] == "Hello World"
    ...
    def test_add_node_legacy_fluent_api_pattern(self):
        ...
        try:
            ...
            with warnings.catch_warnings(record=True) as w:
                ...
                assert builder.nodes["legacy_node"]["type"] == "MockNode"
                assert builder.nodes["legacy_node"]["config"]["param1"] == "value1"
                assert builder.nodes["legacy_node"]["config"]["param2"] == "value2"
...
class TestWorkflowBuilderMetadata:
    ...
    def test_set_metadata(self):
        ...
        try:
            ...
            assert builder._metadata["author"] == "Test Author"
            assert builder._metadata["tags"] == ["test", "validation"]

            # Test updating metadata
            builder.set_metadata(version="1.1.0", priority="high")
            assert builder._metadata["version"] == "1.1.0"
            assert builder._metadata["priority"] == "high"
            assert builder._metadata["name"] == "Test Workflow"  # Should remain
    ...
    def test_update_node_configuration(self):
        ...
        try:
            ...
            assert config["connection_string"] == "sqlite:///:memory:"  # Original
...
class TestWorkflowBuilderParameters:
    ...
    def test_workflow_parameters(self):
        ...
        try:
            ...
            assert builder.workflow_parameters["environment"] == "production"

            # Test updating parameters
            builder.set_workflow_parameters(debug_mode=False, max_retries=5)
            assert builder.workflow_parameters["debug_mode"] is False
            assert builder.workflow_parameters["max_retries"] == 5
            assert (
...
class TestWorkflowBuilderFromDict:
    ...
    def test_from_dict_basic_configuration(self):
        ...
        try:
            ...
            # Verify metadata
            assert builder._metadata["name"] == "Test Workflow"
            assert builder._metadata["description"] == "A workflow from dict"
            assert builder._metadata["version"] == "2.0.0"
...
class TestWorkflowBuilderAdvancedFeatures:
    ...
    def test_deprecated_fluent_methods(self):
        ...
        try:
            ...
            with warnings.catch_warnings(record=True) as w:
                ...
                assert builder.nodes["fluent_node"]["type"] == "TestNode"
                assert builder.nodes["fluent_node"]["config"]["param"] == "value"
    ...
    def test_node_type_convenience_methods(self):
        ...
        try:
            ...
            assert builder.nodes["typed_node"]["type"] == "CSVReaderNode"
            assert builder.nodes["typed_node"]["config"]["file_path"] == "test.csv"
            ...
            assert builder.nodes["instance_node"]["type"] == "MockInstanceNode"
