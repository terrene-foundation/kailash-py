...
class TestKailashClientConfiguration:
    ...
    def test_api_key_configuration(self):
        ...
        try:
            ...
            assert client_with_key.api_key == "secret_key"
...
class TestWorkflowResultUtilities:
    ...
    def test_result_with_optional_fields(self):
        ...
        try:
            ...
            assert minimal_result.result is None
            assert minimal_result.error is None
            assert minimal_result.execution_time is None
            assert minimal_result.is_success is True
            ...
            assert complete_result.result == {"partial": "data"}
            assert complete_result.error == "Something went wrong"
            assert complete_result.execution_time == 45.7
            assert complete_result.is_failed is True
