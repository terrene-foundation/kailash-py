...
from kailash.runtime.validation.suggestion_engine import ValidationSuggestionEngine, ValidationSuggestion
...
class TestErrorCategorizer:
    ...
    def test_security_violation_categorization(self):
        ...
        # SQL injection error
        security_error = ValueError("SQL injection detected in parameter 'query': DROP TABLE")
...
class TestValidationSuggestionEngine:
    ...
    def test_type_mismatch_suggestion(self):
        ...
        assert "type" in suggestion.message.lower() and "match" in suggestion.message.lower()
    ...
    def test_security_violation_suggestion(self):
        ...
        assert "parameterized" in suggestion.code_example.lower() or "sanitize" in suggestion.code_example.lower()
    ...
    def test_dataflow_specific_suggestions(self):
        ...
        assert suggestion is not None
        assert ("dataflow" in suggestion.message.lower() or 
                "model" in suggestion.message.lower())
...
class TestEnhancedErrorFormatterAdditional:
    ...
    def test_format_simple_error(self):
        ...
        error_msg = formatter.format_simple_error(
            "Type mismatch error", context
        )
    ...
    def test_get_error_summary(self):
        ...
        summary = formatter.get_error_summary(
...
class TestConnectionErrorIntegration:
    ...
    def test_complete_error_enhancement_flow(self):
        ...
        assert "Type Mismatch" in enhanced_msg  # Check for exact format from error categorizer
