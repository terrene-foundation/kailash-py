...
from kailash.runtime.validation.performance import (
    PerformanceMetrics, LRUCache, ValidationCache, LazyValidator,
    BatchValidator, PerformanceOptimizer, get_performance_optimizer,
...
class TestValidationCache:
    ...
    def test_compatibility_caching(self):
        ...
        result = TypeCompatibilityResult(
            is_compatible=True,
            confidence=0.9,
            coercion_rule=CoercionRule.INT_TO_FLOAT
        )
        ...
        assert cached_result.is_compatible == True
    ...
    def test_connection_caching(self):
        ...
        from kailash.workflow.type_inference import ConnectionInferenceResult, TypeCompatibilityResult
...
class TestLazyValidator:
    ...
    def test_defer_validation(self):
        ...
        # Defer validation
        validation_id = lazy_validator.defer_validation("test_validation", mock_validation, 5, 10)
    ...
    def test_get_validation_result(self):
        ...
        assert result == 12
        assert "multiply" not in lazy_validator._pending_validations  # Should be cleaned up
...
class TestBatchValidator:
    ...
    def test_add_validation(self):
        ...
        # Add validations
        batch_validator.add_validation("val1", "compatibility", source_type=str, target_type=int)
        batch_validator.add_validation("val2", "connection", source_node="n1", target_node="n2", mapping={})
    ...
    def test_auto_batch_processing(self):
        ...
        batch_validator.add_validation("val1", "compatibility", source_type=str, target_type=int, allow_coercion=True)
        batch_validator.add_validation("val2", "compatibility", source_type=int, target_type=str, allow_coercion=True)
...
class TestPerformanceOptimizer:
    ...
    def test_workflow_optimization_recommendations(self):
        ...
        complex_recommendations = optimizer.optimize_validation_pipeline(complex_workflow)
        
        # Should have different recommendations for complex workflow
        assert len(complex_recommendations["performance_warnings"]) > 0
        assert complex_recommendations["batch_settings"]["enable"] == True
    ...
    def test_resource_cleanup(self):
        ...
        optimizer.lazy_validator._pending_validations["old_validation"]["created_at"] = time.time() - 400
...
class TestPerformanceIntegration:
    ...
    def test_end_to_end_performance_optimization(self):
        ...
        assert report["validation_metrics"]["total_validations"] == 1
        assert report["optimization_status"]["batch_processing_enabled"] == True
