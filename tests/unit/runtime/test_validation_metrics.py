...
class TestValidationMetricsCollector:
    ...
    def test_validation_timing_tracking(self):
        ...
        assert collector.metrics[1].event_type == ValidationEventType.VALIDATION_COMPLETED
    ...
    def test_cache_statistics(self):
        ...
        # Check metrics
        cache_metrics = [m for m in collector.metrics 
                        if m.event_type in [ValidationEventType.CACHE_HIT, 
                                          ValidationEventType.CACHE_MISS]]
    ...
    def test_performance_summary_generation(self):
        ...
        collector.end_validation("n3", "TypeB", success=False, 
...
class TestLocalRuntimeMetricsIntegration:
    ...
    def test_runtime_metrics_reset(self):
        ...
        assert (summary["total_validations"] > 0 or 
                summary["mode_bypasses"] > 0)
