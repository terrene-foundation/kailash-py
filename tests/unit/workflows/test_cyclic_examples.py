...
class TestCyclicExamples:
    ...
    def test_quality_improvement_cycle(self):
        ...
        improver = PythonCodeNode.from_function(
            ...
            input_schema={
                ...
                "improvement_rate": NodeParameter(name="improvement_rate", type=float, required=False, default=0.2)
            }
        )
    ...
    def test_cycle_execution_without_initial_params(self):
        ...
        # Create workflow
        workflow = Workflow(
            workflow_id="default_params_test",
    ...
    def test_cycle_with_early_termination(self):
        ...
        # Create workflow
        workflow = Workflow(
            workflow_id="early_termination_test",
