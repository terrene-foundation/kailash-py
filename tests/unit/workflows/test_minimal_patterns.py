...
class TestSimplifiedWorkflow:
    ...
    def test_simple_transformation_pipeline(self):
        ...
        # Create workflow
        workflow = Workflow(
            workflow_id="transform_pipeline",
    ...
    def test_workflow_with_multiple_steps(self):
        ...
        assert summary["count"] == 4  # Items 2, 3, 4, 5 have values >= 10 (10, 15, 20, 25)
    ...
    def test_single_node_no_inputs(self):
        ...
        computer = PythonCodeNode.from_function(
            func=compute,
            name="computer"
        )
