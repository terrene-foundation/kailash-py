...
class TestServerInfoFunctionality:
    ...
    def test_server_info_health_status_integration(self):
        ...
        try:
            ...
            assert server_with_status.health_status == "unhealthy"
    ...
    def test_server_info_is_healthy_functionality(self):
        ...
        try:
            ...
            assert healthy_server.is_healthy(max_age=300)  # 5 minutes max age
    ...
    def test_server_info_serialization_roundtrip(self):
        ...
        try:
            ...
            assert restored_server.transport == original_server.transport
            assert restored_server.command == original_server.command
            assert restored_server.args == original_server.args
            assert restored_server.capabilities == original_server.capabilities
            assert restored_server.metadata == original_server.metadata
            assert restored_server.health_status == original_server.health_status
            assert restored_server.auth_required == original_server.auth_required
    ...
    def test_server_info_endpoint_extraction_logic(self):
        ...
        try:
            ...
            assert sse_server.endpoint == "https://events.example.com/stream"

            # Test unknown transport
            unknown_server = ServerInfo(name="unknown-server", transport="unknown")
            assert unknown_server.endpoint == "unknown"
            ...
            assert override_server.endpoint == "http://override.com"
    ...
    async def test_file_based_discovery_registration_and_persistence(self):
        ...
        try:
            ...
            with tempfile.TemporaryDirectory() as temp_dir:
                ...
                discovery = FileBasedDiscovery(registry_file=str(registry_file))
    ...
    async def test_file_based_discovery_server_retrieval(self):
        ...
        try:
            ...
            with tempfile.TemporaryDirectory() as temp_dir:
                ...
                assert weather_server.transport == "http"
                ...
                assert auth_server.transport == "stdio"
                assert auth_server.command == "auth-service"
                ...
                assert weather_servers[0].name == "weather-server"
    ...
    async def test_file_based_discovery_server_deregistration(self):
        ...
        try:
            ...
            with tempfile.TemporaryDirectory() as temp_dir:
                ...
                success = await discovery.deregister_server("server2")
                assert success is True
...
class TestServiceRegistryIntegration:
    ...
    async def test_service_registry_multi_backend_coordination(self):
        ...
        try:
            ...
            assert success is True
            assert backend1.register_server.called
            assert backend2.register_server.called
    ...
    async def test_service_registry_server_discovery_aggregation(self):
        ...
        try:
            ...
            assert web_servers[0].name == "web-server"
    ...
    async def test_service_registry_dict_to_server_info_conversion(self):
        ...
        try:
            ...
            assert backend.register_server.called
            call_args = backend.register_server.call_args[0]
            server_info = call_args[0]

            assert isinstance(server_info, ServerInfo)
            assert server_info.name == "config-server"
            assert server_info.transport == "http"
            assert server_info.url == "http://config:8080"
            assert "config.get" in server_info.capabilities
            assert server_info.metadata["version"] == "2.0.0"
            assert server_info.auth_required is True
    ...
    async def test_service_registry_partial_backend_failure_handling(self):
        ...
        try:
            ...
            assert working_backend.register_server.called
            assert failing_backend.register_server.called
    ...
    async def test_network_discovery_port_scanning(self):
        ...
        try:
            ...
            with patch("socket.socket") as mock_socket:
                ...
                mock_sock.connect.return_value = None  # No exception = success
                ...
                mock_sock.connect.assert_called_with(("127.0.0.1", 8080))
    ...
    async def test_service_mesh_client_management(self):
        ...
        try:
            ...
            with patch.object(service_mesh, "_create_client") as mock_create_client:
                ...
                assert selected_server.name == "auth-service"
...
class TestDiscoveryErrorHandling:
    ...
    def test_server_info_edge_cases(self):
        ...
        try:
            ...
            assert minimal_server.name == ""
            assert minimal_server.transport == ""
            assert minimal_server.id is not None  # Should still generate ID
            assert minimal_server.capabilities == []
            assert minimal_server.metadata == {}
            ...
            assert none_server.capabilities == []
            assert none_server.metadata == {}
            assert none_server.health is None
