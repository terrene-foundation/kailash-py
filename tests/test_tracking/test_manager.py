...
class TestTaskManager:
    ...
    def test_create_task(self):
        ...
        task = manager.create_task(
            node_id="test-node", input_data={"value": 42}, metadata={"user": "test"}
        )
    ...
    def test_update_task_status(self):
        ...
        # Update status
        manager.update_task_status(task_id=original_id, status=TaskStatus.RUNNING)
    ...
    def test_task_with_dependencies(self):
        ...
        task2 = manager.create_task(node_id="task2", dependencies=[task1.task_id])
        task3 = manager.create_task(
            node_id="task3", dependencies=[task1.task_id, task2.task_id]
        )
