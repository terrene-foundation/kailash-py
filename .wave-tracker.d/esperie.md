...
| Integration | `dev` | Final all-files hooks, consolidated PR2229 push, exact-head checks and approved merge | root: active | Gate next |
...
new ML237 strict gate passes. Final all-files hooks including pytest-check owed once.
