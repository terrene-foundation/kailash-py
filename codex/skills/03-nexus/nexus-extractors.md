...
- `.codex/skills/03-nexus/handler-status-codes.md` — 500 vs 502/503/504 decision table
- `.codex/skills/03-nexus/nexus-http-status-convention.md` — reference patterns, examples per status code
