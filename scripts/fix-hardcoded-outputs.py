...
def find_hardcoded_outputs(project_root):
    ...
    for root, dirs, files in os.walk(project_root):
        ...
        if any(skip in root for skip in ['.git', '__pycache__', '.pytest_cache', 'node_modules', 'data/outputs']):
            continue
...
def main():
    ...
    if issues:
        ...
        print("2. Replace hardcoded paths with: get_output_data_path('subdir/filename')")
