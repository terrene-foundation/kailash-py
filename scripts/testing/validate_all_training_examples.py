...
class TrainingExampleValidator:
    ...
    def test_code_execution(self, code: str, file_path: str) -> Tuple[bool, str]:
        ...
        try:
            ...
            exec_globals = {
                ...
                'workflow': Workflow("placeholder", "Placeholder"),  # For incomplete examples
    ...
    def validate_example(self, example: Dict) -> Dict:
        ...
        if example_type == "wrong":
            ...
            if syntax_ok and execution_ok:
                ...
                result["issue"] = f"Correct example broken: {syntax_error or execution_error}"
    ...
    def process_file(self, file_path: Path) -> List[Dict]:
        ...
        try:
            ...
            for example in examples:
                ...
                print(f"   {status_emoji} {example_type}: {result['validation_status']}")
    ...
    def print_summary(self):
        ...
        print(f"Correct examples validated: {self.results['correct_examples_validated']}")
        
        print(f"\n🚨 Issues Found:")
        print(f"Wrong examples now working: {len(self.results['wrong_examples_broken'])}")
        print(f"Correct examples broken: {len(self.results['correct_examples_broken'])}")
        ...
        if self.results["wrong_examples_broken"]:
            ...
            for result in self.results["wrong_examples_broken"]:
                file_rel = Path(result["example"]["file"]).relative_to(self.training_dir)
        ...
        # Success criteria
        total_issues = (len(self.results["wrong_examples_broken"]) + 
...
def main():
    ...
    total_issues = (len(validator.results["wrong_examples_broken"]) + 
