...
class TestUserManagement:
    ...
    DB_CONFIG = {
        ...
        "user": "admin",
        "password": "admin",
        "connection_string": "postgresql://admin:admin@localhost:5433/kailash_admin?options=-csearch_path%3Dkailash",
    }
    ...
    async def test_user_crud_operations(self):
        ...
        # Test user creation
        create_result = user_mgmt.execute(
            operation="create",
            user_data={
                "username": "john.doe",
            ...
            tenant_id="b1e7a5d4-7e9c-4f3a-9c2b-1a3b5c7d9e1f",  # Use proper UUID for default tenant
        ...
        read_result = await user_mgmt.execute_async(
            operation="read",
            user_id=user_id,
            tenant_id="b1e7a5d4-7e9c-4f3a-9c2b-1a3b5c7d9e1f",
            include_roles=True,
    ...
    async def test_user_password_management(self):
        ...
        history_result = await user_mgmt.execute_async(
            operation="get_password_history",
            user_id=user_id,
            include_metadata=True
        )
...
class TestRoleManagement:
    ...
    async def test_role_templates(self):
        ...
        assert any(t["name"] == "engineering_lead" for t in templates_result["templates"])
    ...
    async def test_dynamic_permissions(self):
        ...
        time_result = await perm_check.execute_async(
            ...
            context={
                ...
                "contract_days": ["monday", "tuesday", "wednesday", "thursday", "friday"]
            }
        )
