...
from kailash.middleware import (
    ...
    AIChatMiddleware, EventStream, create_gateway
)
from kailash.middleware.communication.events import EventType, EventFilter
...
class TestMiddlewareIntegration:
    ...
    async def test_workflow_creation_and_execution(self, agent_ui_middleware):
        ...
        status = await agent_ui_middleware.get_execution_status(execution_id, session_id)
    ...
    @pytest.mark.asyncio
    async def test_middleware_statistics(self, agent_ui_middleware, realtime_middleware, api_gateway):
...
async def test_complete_middleware_workflow():
    ...
    try:
        ...
        node_id = builder.add_node("PythonCodeNode", "simple_processor", {
        ...
        print(f"✅ Complete middleware workflow test passed")
