...
def find_non_test_files() -> List[Dict[str, Any]]:
    ...
    for test_file in test_files:
        ...
        if (
            analysis["is_documentation"]
            or analysis["is_empty"]
            or (
                not analysis["is_test"]
                and not analysis["has_test_functions"]
                and analysis["size_lines"] > 50
            )
        ):
...
def main():
    ...
    if doc_files:
        ...
        for doc in doc_files:
            ...
            print("     → Move to # contrib (removed)/architecture/ or docs/")
    ...
    if non_tests:
        ...
        if removable:
            ...
            for removal in removable:
                ...
                script_lines.append(
                    f"rm -f '{file_path}'  # Empty file with {removal['size_lines']} lines"
                )
