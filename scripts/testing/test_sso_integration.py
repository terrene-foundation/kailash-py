...
class TestSSOWorkflowIntegration:
    ...
    async def test_sso_security_monitoring(self):
        ...
        builder.add_connection(risk_assessment, "risk_score", threat_detection, "risk_context")
        builder.add_connection(threat_detection, "threats", security_event, "event_details")
    ...
    for suite_name, test_suite in test_suites:
        ...
        for test_name in test_methods:
            ...
            try:
                ...
                if hasattr(test_method, "__code__") and test_method.__code__.co_argcount > 1:
