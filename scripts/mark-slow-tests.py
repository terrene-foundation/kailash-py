    ...
    def visit_FunctionDef(self, node):
        ...
        if node.name in self.slow_methods:
            ...
            has_slow_marker = any(
                ...
                isinstance(dec.value, ast.Attribute) and
                dec.value.attr == 'mark' and 
                dec.attr == 'slow'
...
def find_slow_tests():
    ...
    slow_tests = {
        ...
        'tests/integration/test_workflow_execution.py': ['test_workflow_state_persistence'],
    ...
    integration_tests = {
        ...
        'tests/test_nodes/test_intelligent_orchestration.py': ['test_intelligent_agent_orchestrator'],
    }
