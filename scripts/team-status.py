...
class TeamStatus:
    ...
    def get_github_data(self) -> Dict[str, Any]:
        ...
        # Get open issues
        try:
            cmd = ['gh', 'issue', 'list', '--state', 'open', '--json', 
        ...
        # Get project items
        try:
            cmd = ['gh', 'project', 'item-list', str(self.project_number),
    ...
    def generate_daily_report(self) -> str:
        ...
        avg_capacity = sum(w['capacity_percent'] for w in workload.values()) / max(len(workload), 1)
