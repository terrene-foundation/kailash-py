...
| ---------------- | ------------------ | --------------- |
| kailash (core)   | `v*`               | 2.13.2          |
| kailash-dataflow | `dataflow-v*`      | 2.7.3           |
| kailash-kaizen   | `kaizen-v*`        | 2.14.0          |
