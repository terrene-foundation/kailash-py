...
| ---------------- | ------------------ | --------------- |
| kailash (core)   | `v*`               | 2.13.3          |
| kailash-dataflow | `dataflow-v*`      | 2.7.5           |
| kailash-kaizen   | `kaizen-v*`        | 2.16.0          |
| kailash-nexus    | `nexus-v*`         | 2.6.0           |
