...
//
//   validateDeferralDeclaration — the declaration contract (all seven fields,
//                                 substantive reason/graduation, a REAL calendar
//                                 expiry, and the past-expiry hard fail that is
...
for (const field of ["rule", "quote", "detector", "risk", "reason", "graduation", "expires"]) {
  const decl = { ...BASE };
  delete decl[field];
