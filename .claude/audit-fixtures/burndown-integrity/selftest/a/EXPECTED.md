...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Alpha | 3⟨TOKEN⟩ | 3⟨TOKEN⟩ | 0⟨TOKEN⟩ | 0⟨TOKEN⟩ | 0⟨TOKEN⟩ | 0⟨TOKEN⟩ | 0⟨TOKEN⟩ | 0⟨TOKEN⟩ | 0⟨TOKEN⟩ |
| Beta | 2⟨TOKEN⟩ | 0⟨TOKEN⟩ | 0⟨TOKEN⟩ | 1⟨TOKEN⟩ | 1⟨TOKEN⟩ | 0⟨TOKEN⟩ | 2⟨TOKEN⟩ | 2⟨TOKEN⟩ | 0⟨TOKEN⟩ |
| **ALL PAGES** | **5⟨TOKEN⟩** | **3⟨TOKEN⟩** | **0⟨TOKEN⟩** | **1⟨TOKEN⟩** | **1⟨TOKEN⟩** | **0⟨TOKEN⟩** | **2⟨TOKEN⟩** | **2⟨TOKEN⟩** | **0⟨TOKEN⟩** |

A page is complete only when `Signed off` equals `total`. Alpha is complete (3 of 3). Beta is not (0 of 2).
