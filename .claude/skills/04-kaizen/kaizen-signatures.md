...
- **Source**: `packages/kailash-kaizen/src/kaizen/signatures/`
- **Examples**: All agents in `packages/kailash-kaizen/examples/`
- **Tests**: `packages/kailash-kaizen/tests/unit/signatures/`
