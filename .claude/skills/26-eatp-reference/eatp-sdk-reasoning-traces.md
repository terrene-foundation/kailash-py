...
**Source**: `src/kailash/trust/reasoning.py`
**Crypto**: `src/kailash/trust/crypto.py` (hash/sign/verify reasoning functions)
**Operations**: `src/kailash/trust/operations/__init__.py` (delegate/audit accept reasoning_trace)
